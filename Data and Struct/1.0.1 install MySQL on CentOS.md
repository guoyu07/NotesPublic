...
```
# Linux Generial Installation
[MySQL Binary Installation](http://dev.mysql.com/doc/refman/5.7/en/binary-installation.html)
Download tar.gz
Source Code > Generic Linux (Architecture Independent), Compressed TAR Archive Includes Boost Headers
```
sh$ curl -sSL "http://dev.mysql.com/get/Downloads/MySQL-5.7/mysql-boost-5.7.12.tar.gz" -o "mysql-boost-5.7.12.tar.gz"

sh$ yum install libaio
 ...
 */
sh$ sudo rpm -Uvh http://dev.mysql.com/get/mysql57-community-release-el7-8.noarch.rpm

sh$ sudo rpm --import /etc/pki/rpm-gpg/RPM-GPG-KEY-*
...
## Can't find my.cnf
```
sh$ cp /usr/share/mysql/my-default.cnf /etc/my.cnf
[mysqld]
