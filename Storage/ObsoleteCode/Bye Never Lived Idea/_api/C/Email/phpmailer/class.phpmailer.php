...
/**
 * PHPMailer - PHP mail creation and transport class.
 * @package PHPMailer
...
class PHPMailer
{
    ...
    /**
     * The From mail address for the message.
     * @type string
     */
    ...
    /**
     * The Sender mail (Return-Path) of the message.
     ...
     * This body can be read by mail clients that do not have HTML mail
    ...
    /**
     * The mail address that a reading confirmation should be sent to.
     * @type string
     */
    ...
    /**
     * DKIM Identity.
     * Usually the mail address used as the source of the mail
     * @type string
     */
     ...
     *
     * The function that handles the result of the send mail action.
     * It is called out by send() for each mail sent.
     *
     ...
     *   string  $from          mail address of sender
     * @type string
     */
    ...
    /**
     * Return the Message-ID header of the last mail.
    ...
    /**
     * Check that a string looks like an mail address.
     ...
     * * `html5` Use the pattern given by the HTML5 spec for 'mail' type form input elements.
    ...
    public static function validateAddress($address, $patternselect = 'auto')
    {
        ...
        switch ($patternselect) {
            case 'pcre8':
                 ...
                 * @link http://squiloople.com/2009/12/20/mail-address-validation/
            ...
            case 'html5':
                /**
                 * This is the pattern used in the HTML5 spec for validation of 'mail' type form input elements.
                 * @link http://www.whatwg.org/specs/web-apps/current-work/#e-mail-state-(type=mail)
                 */
     ...
     * Send the mail via the selected mechanism
     * @throws phpmailerException
     * @return bool
     */
