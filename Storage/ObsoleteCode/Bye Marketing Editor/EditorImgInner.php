...
<style>*{margin:0;padding:0}p{height:28px;line-height:28px}textarea{resize:vertical}.changecolor p{color:#090;font-weight:700}</style>
<?php
...
imageWaterMark($savefilename,0,$site.'.png');}
}
else {
...
if(strlen($imgalt)>0){echo '<textarea style="width:100%;height:45px" id="imgforfile"><div class="fo"><img alt="',$imgalt,'" i="',$savefilename,'" width="',$imgw,'" height="',$imgh,'"><p>',$imgalt,'</p></div></textarea>';}
else {echo '<textarea style="width:100%;height:45px" id="imgforfile"><div class="fo"><img i="',$savefilename,'" width="',$imgw,'" height="',$imgh,'"></div></textarea>';}
echo '<p>远程图片地址：http://tp.v-get.com/i/',$savefilename,'<p><p></p><img src="http://tp.v-get.com/i/',$savefilename,'" width="',$imgw,'" height="',$imgh,'" alt="FTP服务器图片，没成功就没显示">';


}
if(isset($_POST['urlfile'])&&isset($_POST['time'])&&isset($_POST['timeid'])&&isset($_POST['datetime'])){
