<?php
/**
 * PHPMailer - PHP mail transport unit tests
...
/**
 * PHPMailer - PHP mail transport unit test class
...
EOT;
    ...
    {
        $this->Mail->Body = 'This is the <strong>HTML</strong> part of the mail.';
    ...
    public function testAltBody()
    {
        ...
        $this->Mail->AltBody = 'Here is the text body of this message.  ' .
            ...
            '40 characters.  Make sure that it is.';
        $this->Mail->WordWrap = 40;
        $this->addNote('This is a mulipart alternative mail');
    ...
    {
        $this->Mail->Body = 'This is the <strong>HTML</strong> part of the mail.';
        $this->Mail->AltBody = 'This is the text part of the mail.';
    ...
    public function testError()
    {
        ...
        $this->assertEquals('You must provide at least one recipient mail address.', $this->Mail->ErrorInfo);
