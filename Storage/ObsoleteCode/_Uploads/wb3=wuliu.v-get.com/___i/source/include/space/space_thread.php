...
$gets=array('mod' => 'space','username' => $space['username'],'do' => 'thread','fid' => $_GET['fid'],'view' => $_GET['view'],'type' => $_GET['type'],'order' => $_GET['order'],'fuid' => $_GET['fuid'],'searchkey' => $_GET['searchkey'],'from' => $_GET['from'],'filter' => $_GET['filter']);
$theurl='http://wuliu.v-get.com/i/'.$space['username'];
unset($gets['fid']);
$forumurl='http://wuliu.v-get.com/i/home.php?'.url_implode($gets);
$multi='';
$authorid=0;
