	...
	if(!$(menuid)) {
		switch(tag) {
			...
			case 'url':
				...
				submitstr = "$('" + ctrlid + "_param_2').value !== '' ? seditor_insertunit('" + seditorkey + "', '[url='+seditor_squarestrip($('" + ctrlid + "_param_1').value)+']'+$('" + ctrlid + "_param_2').value, '[/url]', null, 1) : seditor_insertunit('" + seditorkey + "',$('"+ctrlid+"_param_1').value,'', null, 1);hideMenu();";
				break;
			case 'code':
			case 'quote':
