...
if($view == 'userapp') {
	...
	if($_GET['op'] == 'del') {
		...
		showmessage('do_success', "http://e.v-get.com/i/home.php?mod=space&do=notice&view=userapp&quickforward=1");
	}
	...
	if($count) {
		...
		$multi = '';
		$multi = multi($count, $perpage, $page, "http://e.v-get.com/i/home.php?mod=space&do=$do&isread=1");
	}
