...
<html xmlns="http://www.w3.org/1999/xhtml"><head><base target="_blank"><meta http-equiv="Content-Type" content="text/html;charset=utf-8" /><link href="http://tu.v-get.com/i.ico" type="image/ico" rel="shortcut icon" /><title>E维科技管理中心</title><link rel="stylesheet" href="static/image/admincp/admincp.css" type="text/css" media="all" /></head><body>
EOT;

	if($form) {
		echo <<<EOT
<script language="JavaScript">if(self.parent.frames.length!=0){self.parent.location=document.location;}</script><table class="logintb"><tr><td class="login"><h1>E维科技管理中心</h1><p>管理中心是 <a href="http://e.v-get.com/">E维科技</a> 公司( <a href="http://www.v-get.com/">V-Get!</a> 旗下)推出的后台管理系统，帮助企业网站实现一站式服务。</p></td><td>
EOT;
	}
}
...
function html_login_footer($halt = true) {
	echo <<<EOT
</td></tr></table><table class="logintb"><tr><td colspan="2" class="footer"><div class="copyright"><p>Powered by <a href="http://e.v-get.com/i/">V-Get! Tech</a> </p><p>&copy; 2012-2013, <a href="http://www.v-get.com/">V-Get</a> .com</p></div></td></tr></table></body></html>
