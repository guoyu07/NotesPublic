...
0
|| checktplrefresh('./template/default/home/space_thread.htm', './template/default/home/space_header.htm', 1371823091, 'diy', './data/template/1_diy_home_space_thread.tpl.php', './template/default', 'home/space_thread')
|| checktplrefresh('./template/default/home/space_thread.htm', './template/default/common/userabout.htm', 1371823091, 'diy', './data/template/1_diy_home_space_thread.tpl.php', './template/default', 'home/space_thread')
|| checktplrefresh('./template/default/home/space_thread.htm', './template/default/home/space_userabout.htm', 1371823091, 'diy', './data/template/1_diy_home_space_thread.tpl.php', './template/default', 'home/space_thread')
|| checktplrefresh('./template/default/home/space_thread.htm', './template/default/common/header_common.htm', 1371823091, 'diy', './data/template/1_diy_home_space_thread.tpl.php', './template/default', 'home/space_thread')
|| checktplrefresh('./template/default/home/space_thread.htm', './template/default/home/space_diy.htm', 1371823091, 'diy', './data/template/1_diy_home_space_thread.tpl.php', './template/default', 'home/space_thread')
|| checktplrefresh('./template/default/home/space_thread.htm', './template/default/home/space_header_personalnv.htm', 1371823091, 'diy', './data/template/1_diy_home_space_thread.tpl.php', './template/default', 'home/space_thread')
;?>
<?php $filter = array( 'common' => '已发表', 'save' => '草稿箱', 'close' => '已关闭', 'aduit' => '待审核', 'ignored' => '已忽略', 'recyclebin' => '回收站');
$_G[home_tpl_spacemenus][] = "<a href=\"home.php?mod=space&amp;uid=$space[uid]&amp;do=thread&amp;view=me\">TA 的所有帖子</a>";?><?php if($diymode) { if($_G['setting']['homepagestyle']) { $_G[cookie][extstyle] = false;?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
...
<td class="icn">
<a href="http://e.v-get.com/i/tip-<?php echo $thread['tid'];?>-1-1.html?highlight=<?php echo $index['keywords'];?>" title="新窗口打开" target="_blank">
...
<?php if($actives['me']) { ?>
<td class="by"><cite><a href="http://e.v-get.com/i/<?php echo $thread['lastposterenc'];?>" target="_blank"><?php echo $thread['lastposter'];?></a></cite><em><a href="http://e.v-get.com/i/tip-<?php echo $thread['tid'];?>-1-1.html?mod=redirect&goto=lastpost#lastpost" target="_blank"><?php echo $thread['lastpost'];?></a></em></td>
<?php } } ?>
</tr>
