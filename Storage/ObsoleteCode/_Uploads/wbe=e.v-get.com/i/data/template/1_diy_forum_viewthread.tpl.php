...
0
|| checktplrefresh('./template/default/forum/viewthread.htm', './template/default/forum/viewthread_node.htm', 1371824754, 'diy', './data/template/1_diy_forum_viewthread.tpl.php', './template/default', 'forum/viewthread')
|| checktplrefresh('./template/default/forum/viewthread.htm', './template/default/forum/viewthread_fastpost.htm', 1371824754, 'diy', './data/template/1_diy_forum_viewthread.tpl.php', './template/default', 'forum/viewthread')
|| checktplrefresh('./template/default/forum/viewthread.htm', './template/default/forum/viewthread_node_body.htm', 1371824754, 'diy', './data/template/1_diy_forum_viewthread.tpl.php', './template/default', 'forum/viewthread')
|| checktplrefresh('./template/default/forum/viewthread.htm', './template/default/common/seditor.htm', 1371824754, 'diy', './data/template/1_diy_forum_viewthread.tpl.php', './template/default', 'forum/viewthread')
|| checktplrefresh('./template/default/forum/viewthread.htm', './template/default/common/seccheck.htm', 1371824754, 'diy', './data/template/1_diy_forum_viewthread.tpl.php', './template/default', 'forum/viewthread')
|| checktplrefresh('./template/default/forum/viewthread.htm', './template/default/common/upload.htm', 1371824754, 'diy', './data/template/1_diy_forum_viewthread.tpl.php', './template/default', 'forum/viewthread')
...
<?php } } else { if(!$_G['forum_thread']['is_archived']) { ?><a id="newspecial" href="forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>" title="发表帖子" target="_self"><img src="<?php echo IMGDIR;?>/pn_post.png" alt="发帖" /></a><?php } } ?>
...
<?php } ?>
<a href="http://e.v-get.com/i/tip-<?php echo $_G['tid'];?>-1-1.html" onclick="return copyThreadUrl(this)" title="http://e.v-get.com/i/tip-<?php echo $_G['tid'];?>-1-1.html" fromuid="<?php echo $fromuid;?>">[短链接]</a>
</span>
...
<div class="pi">
<div class="authi"><a href="http://e.v-get.com/i/<?php echo $post['author'];?>" class="xw1"><?php echo $post['author'];?></a></div>
</div>
<?php } if($showavatars) { ?>
<div>
...
<a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=thread&amp;id=<?php echo $_G['tid'];?>" id="k_favorite" onclick="showWindow(this.id,this.href,'get',0);" onmouseover="this.title=$('favoritenumber').innerHTML+'人收藏'" title="收藏本帖">收藏<span id="favoritenumber"<?php if(!$_G['forum_thread']['favtimes']) { ?> style="display:none"<?php } ?>><?php echo $_G['forum_thread']['favtimes'];?></span></a>
</em>
...
<?php if($multipage && $page < $_G['setting']['threadmaxpages'] && $page < $_G['page_next']) { $nxtpage = $page + 1;?><div class="pgbtn"><a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?><?php if($_GET['authorid']) { ?>&amp;authorid=<?php echo $_GET['authorid'];?><?php } ?>&amp;page=<?php echo $nxtpage;?>" hidefocus="true" class="bm_h">下一页 &raquo;</a></div><?php } ?>
...
if(values['type'] == 'add') {
fObj.innerHTML = '不收听';fObj.href = 'home.php?mod=spacecp&ac=follow&op=del&fuid='+values['fuid'];
