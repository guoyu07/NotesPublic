...
0
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_editor_extra.htm', 1371826968, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_editor_body.htm', 1371826968, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_editor_attribute.htm', 1371826968, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/common/seccheck.htm', 1371826968, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/common/editor_menu.htm', 1371826968, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/editor_menu_forum.htm', 1371826968, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/common/upload.htm', 1371826968, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/common/editor.htm', 1371826968, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_attachlimit.htm', 1371826968, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_attachlimit.htm', 1371826968, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_attachlimit.htm', 1371826968, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_attachlimit.htm', 1371826968, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
;?><?php include template('common/header'); ?><script type="text/javascript">
var allowpostattach = parseInt('<?php echo $_G['group']['allowpostattach'];?>'),allowpostimg = parseInt('<?php echo $allowpostimg;?>'),pid = parseInt('<?php echo $pid;?>'),tid = parseInt('<?php echo $_G['tid'];?>'),extensions = '<?php echo $_G['group']['attachextensions'];?>',imgexts = '<?php echo $imgexts;?>',postminchars = parseInt('<?php echo $_G['setting']['minpostsize'];?>'),postmaxchars = parseInt('<?php echo $_G['setting']['maxpostsize'];?>'),disablepostctrl = parseInt('<?php echo $_G['group']['disablepostctrl'];?>'),seccodecheck = parseInt('<?php if(checkperm('seccode') && $seccodecheck) { ?>1<?php } else { ?>0<?php } ?>');
var secqaacheck = parseInt('<?php if(checkperm('seccode') && $secqaacheck) { ?>1<?php } else { ?>0<?php } ?>');
var typerequired = parseInt('<?php echo $_G['forum']['threadtypes']['required'];?>'),sortrequired = parseInt('<?php echo $_G['forum']['threadsorts']['required'];?>'),special = parseInt('<?php echo $special;?>');
var isfirstpost = <?php if($isfirstpost) { ?>1<?php } else { ?>0<?php } ?>;
var allowposttrade = parseInt('<?php echo $_G['group']['allowposttrade'];?>'),allowpostreward = parseInt('<?php echo $_G['group']['allowpostreward'];?>'),allowpostactivity = parseInt('<?php echo $_G['group']['allowpostactivity'];?>'),sortid = parseInt('<?php echo $sortid;?>'),special = parseInt('<?php echo $special;?>'),fid = <?php echo $_G['fid'];?>,postaction = '<?php echo $_GET['action'];?>';
...
<div class="z"><a href="http://e.v-get.com/" class="nvhm" title="E维科技">E维科技</a> <?php echo $navigation;?><?php echo $actionsubject;?> <em>&rsaquo;</em> <?php echo $actiontitle;?></div>
...
<span><input type="text" placeholder="当前板块：<?php echo $_G['forum']['name'];?>" name="subject" id="subject" class="px" value="<?php echo $postinfo['subject'];?>" <?php if($_GET['action'] == 'newthread') { ?>onblur="if($('tags')){relatekw('-1','-1'<?php if($_G['group']['allowposttag']) { ?>,function(){extraCheck(4)}<?php } ?>);doane();}"<?php } ?> onkeyup="strLenCalc(this, 'checklen',75);" style="width: 25em" tabindex="1" /></span>
<?php } else { ?>
<span id="subjecthide" class="z">RE: <?php echo $thread['subject'];?> [<a href="javascript:;" onclick="display('subjecthide');display('subjectbox');$('subject').value='RE: <?php echo dhtmlspecialchars(str_replace('\'', '\\\'', $thread['subject'])); ?>';display('subjectchk');strLenCalc($('subject'), 'checklen', 75);return false;">修改</a>]</span>
<span id="subjectbox" style="display:none"><input type="text" name="subject" id="subject" class="px" value="" onkeyup="strLenCalc(this, 'checklen', 75);" style="width: 25em" /></span>
<?php } ?>			
<span id="subjectchk"<?php if($_GET['action']=='reply') { ?> style="display:none"<?php } ?>>还可以输入 <strong id="checklen">75</strong> 个字符 &nbsp; <a href="http://e.v-get.com/i/">[切换板块]</a></span>
<script type="text/javascript">strLenCalc($('subject'),'checklen',75)</script>
