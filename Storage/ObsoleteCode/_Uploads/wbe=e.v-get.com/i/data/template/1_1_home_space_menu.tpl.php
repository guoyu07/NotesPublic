...
0
|| checktplrefresh('./template/default/home/space_menu.htm', './template/default/home/follow_user_header.htm', 1371823170, '1', './data/template/1_1_home_space_menu.tpl.php', './template/default', 'home/space_menu')
;?>
<?php if($space['uid']) { ?>
<div id="uhd">
<?php if(CURMODULE == 'follow') { ?><div class="flw_hd">
<?php if(helper_access::check_module('follow')) { ?>
<div class="tns"><table cellspacing="0" cellpadding="0"><tr><th><p><a href="home.php?mod=follow&amp;uid=<?php echo $uid;?>&amp;do=view" class="xi2 xw1"><?php echo $space['feeds'];?></a></p><span><a href="home.php?mod=follow&amp;uid=<?php echo $uid;?>&amp;do=view" class="xi2">广播</a></span></th><th><p><a href="home.php?mod=follow&amp;do=following&amp;uid=<?php echo $uid;?>" class="xi2 xw1"><?php echo $space['following'];?></a></p><span><a href="home.php?mod=follow&amp;do=following&amp;uid=<?php echo $uid;?>" class="xi2">收听</a></span></th><td><p><a href="home.php?mod=follow&amp;do=follower&amp;uid=<?php echo $uid;?>" id="followernum_<?php echo $uid;?>" class="xi2 xw1"><?php echo $space['follower'];?></a></p><span><a href="home.php?mod=follow&amp;do=follower&amp;uid=<?php echo $uid;?>" id="followernum_<?php echo $uid;?>" class="xi2">听众</a></span></td></tr></table></div>
<?php } if(!$viewself) { ?>
<div class="mtm o cl"><div id="followflag" <?php if(!isset($flag[$_G['uid']])) { ?>style="display: none"<?php } ?>>
<?php if(helper_access::check_module('follow')) { ?>
...
function succeedhandle_followmod(url, msg, values){var fObj=$('followmod');if(values['type']=='add'){fObj.innerHTML='取消收听';fObj.href = 'home.php?mod=spacecp&ac=follow&op=del&fuid='+values['fuid'];}else if(values['type']=='del') {fObj.innerHTML = '收听TA';fObj.href = 'home.php?mod=spacecp&ac=follow&op=add&hash=<?php echo FORMHASH;?>&fuid='+values['fuid'];}}
</script>
<?php } ?>
</div>
<?php } ?>
<div class="h cl"><div class="icn avt"><a href="http://e.v-get.com/i/<?php echo $space['username'];?>"><?php echo avatar($space[uid],small);?></a></div>
<h2 class="mt"><?php echo $space['username'];?>
...
<p>
<a href="http://e.v-get.com/i/<?php echo $space['username'];?>" class="xg1">http://e.v-get.com/i/<?php echo $space['username'];?></a>
...
<?php if(!empty($_G['setting']['pluginhooks']['space_menu_extra'])) echo $_G['setting']['pluginhooks']['space_menu_extra'];?><ul class="tb cl" style="padding-left: 75px;"><li<?php if($do=='thread') { ?> class="a"<?php } ?>><a href="http://e.v-get.com/i/<?php echo $space['username'];?>">帖子</a></li><li<?php if($do==profile) { ?> class="a"<?php } ?>><a href="http://e.v-get.com/i/<?php echo $space['username'];?>?do=profile">个人资料</a></li></ul></div>
<?php } ?>