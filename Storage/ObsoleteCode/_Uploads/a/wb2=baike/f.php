...
$I=$_GET['i'];
$Qq=mysql_query('SELECT * FROM f WHERE i='.$I);
$Qr=mysql_num_rows($Qq);if($Qr==0){header('Location: http://baike.v-get.com/');exit();}
$Qa=mysql_fetch_array($Qq);
$H=$Qa['h'];$D=$Qa['d'];$K=$Qa['k'];?>
<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><?php echo '<title>',$H,'_商务百科_V-Get!</title><meta name="keywords" content="',$K,'" /><meta name="description" content="',$D,'" />';?>
...
<div class="u">
<div class="i">
<div class="p il"><h1><?php echo $H;?></h1></div><div class="p ir"><p>成功人士的商务百科</p><p>baike.v-get.com</p></div>
<div class="o"></div>
</div>
...
<div class="m mb">您的位置：
<?php
if(isset($_GET['l'])){$lk=$_GET['l'];echo '<a href="http://www.v-get.com/">首页</a>&nbsp;&gt;&gt;&nbsp;<a href="http://',$lk,'.v-get.com/">商务分站</a>&nbsp;&gt;&gt;&nbsp;<a href="http://baike.v-get.com/">百科知识</a>&nbsp;&gt;&gt;&nbsp;<a href="http://',$lk,'.v-get.com/">分站百科</a>';}else {echo '<a href="http://www.v-get.com/">首页</a>&nbsp;&gt;&gt;&nbsp;<a href="http://baike.v-get.com/">百科知识</a>';}
...
<div class="q">商务百科中的词条正文与判断内容仅供用户参考，具体商业操作需要根据商业环境决定。如果您需要最佳的商业解决方案，建议您咨询专业的企业人士。</div>
<div class="o"></div></div>
...
J('http://www.v-get.com/www.v-getimg.com/i0/s2/f.js');
</script>
