...
//b global==本市local  本省state + c 的
//a logistics===tuoyun/huodai/huoche ...
//c global
//$a=$_GET['a']; 用数组 替换，如果$A=0，就不用
$A=0;
//$b=$_GET['b'];
$B=0;
...
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><meta name="msvalidate.01" content="91FAF445D0EBEE6A9959D755F714DB9E" /><title>物流百科_中国物流查询网_V-Get!</title>
...
<div class="w">
<div class="t"><a href="http://www.v-get.com/">V-Get!首页</a></div>
<div class="n">
<div class="p nl"><img src="http://weigeti.com/p0/v2b.gif" /></div>
<div class="q s">
...
<div class="v">
<?php 
echo '<div class="p f c"><div id="m">您的位置：<a href="http://www.v-get.com/">主页</a> &gt; <a href="http://wuliu.v-get.com/">商务物流</a> &gt; <a href="http://yiwu.wuliu.v-get.com/">义乌物流</a> &gt; 物流百科</div>';
$rw='s=3';
if($A>0){$rw.=' AND a='.$A;}if($B>0){$rw.=' AND (b=0 OR b='.$B.')';}if($C>0){$rw.=' AND c='.$C;}
...
$Pq=($Pp==1)?'':'-'.$Pp;
switch ($p)
{ case 1:$pg='<div class="pg"><a class="po">首页</a><a class="po">前一页&lt;</a>第<b>1</b>页<a href="http://wuliu.baike.v-get.com/?p=2" target="_self">&gt;下一页</a><a href="http://wuliu.baike.v-get.com/?p='.$Pz.'" target="_self">共'.$Pz.'页</a></div>';break;
 case $Pz:$pg='<div class="pg"><a href="wuliu.baike.v-get.com/" target="_self">首页</a><a href="http://wuliu.baike.v-get.com/?p='.$Pp.'" target="_self">前一页&lt;</a>第<b>'.$p.'</b>页<a class="po">&gt;下一页</a><a class="po">第'.$p.'页</a></div>';break;
  default:$pg='<div class="pg"><a href="http://wuliu.baike.v-get.com/" target="_self">首页</a><a href="http://wuliu.baike.v-get.com/?p='.$Pp.'" target="_self">前一页&lt;</a>第<b>'.$p.'</b>页<a href="http://wuliu.baike.v-get.com/?p='.$Pn.'" target="_self">&gt;下一页</a><a href="http://wuliu.baike.v-get.com/?p='.$Pz.'" target="_self">第'.$Pz.'页</a></div>';break;
}}
$pg='';
echo $pg.'<div id="c">';
...
$I=$r['i'];
echo '<div><h2><a href="http://baike.v-get.com/view/'.$I.'.html">'.$r['h'].'</a><span>'.$r['t'].'</span></h2><p>'.$r['d'].'<a href="http://www.google.com.hk/search?hl=zh-CN&domains=v-get.com&sitesearch=v-get.com&ie=utf-8&q='.$r['k'].'&x=0&y=0">相似阅读</a></p></div>';
}
echo '</div>'.$pg;
echo '</div>';
?>
<div class="q r">
<div class="rw"><script type="text/javascript">var cpro_id="u1132461"</script><script src="http://cpro.baidustatic.com/cpro/ui/c.js" type="text/javascript"></script></div><div class="f rw">
<h5>每日推荐</h5>
