...
$Pq=($Pp==1)?'':'_'.$Pp;
switch ($p)
{ case 1:$pg='<div class="pg"><a class="po">首页</a><a class="po">前一页&lt;</a>第<b>1</b>页<a href="http://baike.v-get.com/list/index_2.html" target="_self">&gt;下一页</a><a href="http://baike.v-get.com/list/index_'.$Pz.'.html" target="_self">共'.$Pz.'页</a></div>';break;
 case $Pz:$pg='<div class="pg"><a href="http://baike.v-get.com/list/index_1.html" target="_self">首页</a><a href="http://baike.v-get.com/list/index_'.$Pp.'.html" target="_self">前一页&lt;</a>第<b>'.$p.'</b>页<a class="po">&gt;下一页</a><a class="po">第'.$p.'页</a></div>';break;
  default:$pg='<div class="pg"><a href="http://baike.v-get.com/list/index_1.html" target="_self">首页</a><a href="http://baike.v-get.com/list/index_'.$Pp.'.html" target="_self">前一页&lt;</a>第<b>'.$p.'</b>页<a href="http://baike.v-get.com/list/index_'.$Pn.'.html" target="_self">&gt;下一页</a><a href="http://baike.v-get.com/list/index_'.$Pz.'.html" target="_self">第'.$Pz.'页</a></div>';break;
}}
$pg='';
echo $pg.'<div id="c">';
...
$I=$r['i'];
echo '<div><h2><a href="http://baike.v-get.com/view/'.$I.'.html" target="_blank">'.$r['h'].'</a><span>'.$r['t'].'</span></h2><p>'.$r['d'].'<a href="http://www.google.com.hk/search?hl=zh-CN&domains=v-get.com&sitesearch=v-get.com&ie=utf-8&q='.$r['k'].'&x=0&y=0">相似阅读</a></p></div>';
}
echo '</div>'.$pg;
echo '</div></div>';
?>
...
</div></div><div style="display:none"><script type="text/javascript">Q();A();$("bdshell_js").src="http://bdimg.share.baidu.com/static/js/shell_v2.js?cdnversion="+new Date().getHours();var _bdhmProtocol=(("https:"==document.location.protocol)?" https://":" http://");document.write(unescape("%3Cscript src='"+_bdhmProtocol + "hm.baidu.com/h.js%3F1647779f45896943c60c75fb905f6360' type='text/javascript'%3E%3C/script%3E"));</script><script type="text/javascript">var cpro_id = "u1132441";</script><script src="http://cpro.baidustatic.com/cpro/ui/f.js" type="text/javascript"></script></div></body></html>