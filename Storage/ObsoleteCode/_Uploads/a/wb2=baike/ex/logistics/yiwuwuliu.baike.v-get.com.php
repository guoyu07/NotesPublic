...
$Qs='SELECT * FROM f WHERE s=3 AND (b=330782 OR b=0) '.$QK.' ORDER BY t DESC LIMIT '.$Qp.',10';
$Qq=mysql_query($Qs,$QC);
$Qy=mysql_query('SELECT COUNT(*) FROM f WHERE s=3 AND (b=330782 OR b=0)'.$QK,$QC);
$Qz=mysql_fetch_array($Qy);
$Qt=$Qz[0];$Pz=ceil($Qt/10);
?>
<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><title>义乌物流百科_商务物流网_V-Get!</title><meta name="keywords" content="义乌 物流百科 物流 义乌物流" />
...
<div class="f mb l2">
<ul><li><a href="http://news.v-get.com/2013-01-01/3.html">义乌市制定全国首个国际货代地方标准</a> </li>
...
<div class="mb" id="al"><script type="text/javascript">var sogou_ad_id=150888,sogou_ad_height=250,sogou_ad_width=250;</script><script language='JavaScript' type='text/javascript' src='http://images.sohu.com/cs/jsfile/js/c.js'></script></div>
...
<div class="p c">
<div class="cs">
<form action="http://yiwuwuliu.baike.v-get.com/logistics/index_1.html" id="cfs">
...
echo '<div class="cf"><h2><a href="http://baike.v-get.com/view/',$Qa['i'],'.html">',$Qa['h'],'</a></h2><p>',$Qa['d'],'</p><div class="a cfk">';
$K=$Qa['k'];$aK=explode(' ',$K);
foreach($aK as $ka=>$KA){
echo '<a href="#">',$KA,'</a>';
}

echo '<div class="o"></div></div><p class="cfb">',$Qa['t'],'　<span>来源：',$Qa['n'],'</span></p></div>';
}
echo '</div>';
if($Pz>1){
$Pp=$sp-1;$Pn=$sp+1;
$Pq=($Pp==1)?'':'_'.$Pp;
switch ($sp)
{ case 1:echo '<div class="pg"><a class="po">首页</a><a class="po">前一页&lt;</a>第<b>1</b>页<a href="http://yiwuwuliu.baike.v-get.com/logistics/index_2.html',$key,'" target="_self">&gt;下一页</a><a href="http://yiwuwuliu.baike.v-get.com/logistics/index_'.$Pz.'.html',$key,'" target="_self">共'.$Pz.'页</a></div>';break;
 case $Pz:echo '<div class="pg"><a href="http://yiwuwuliu.baike.v-get.com/logistics/index_1.html',$key,'" target="_self">首页</a><a href="http://yiwuwuliu.baike.v-get.com/logistics/index_'.$Pp.'.html',$key,'" target="_self">前一页&lt;</a>第<b>'.$sp.'</b>页<a class="po">&gt;下一页</a><a class="po">第'.$sp.'页</a></div>';break;
  default:echo '<div class="pg"><a href="http://yiwuwuliu.baike.v-get.com/logistics/index_1.html',$key,'" target="_self">首页</a><a href="http://yiwuwuliu.baike.v-get.com/logistics/index_'.$Pp.'.html',$key,'" target="_self">前一页&lt;</a>第<b>'.$sp.'</b>页<a href="http://yiwuwuliu.baike.v-get.com/logistics/index_'.$Pn.'.html',$key,'" target="_self">&gt;下一页</a><a href="http://yiwuwuliu.baike.v-get.com/logistics/index_'.$Pz.'.html',$key,'" target="_self">第'.$Pz.'页</a></div>';break;
}}
...
<div class="r2 rw"><h4>|<a href="http://wuliu.news.v-get.com/">物流新闻</a></h4><ul><li><a href="http://news.v-get.com/2013-01-01/192.html">物流“最后一公里”决定电商</a></li><li><a href="http://news.v-get.com/2013-01-01/191.html">“双十一”物流快递或取代电</a></li><li><a href="http://news.v-get.com/2013-01-01/190.html">江苏降低物流成本，促进物流</a></li><li><a href="http://news.v-get.com/2013-01-01/189.html">申通“撇腿”京东，电商和物</a></li><li><a href="http://news.v-get.com/2013-01-01/188.html">国际物流企业抢占国内市场，</a></li><li><a href="http://news.v-get.com/2013-01-01/187.html">南宁力争亚洲最大特色农产品</a></li><li><a href="http://news.v-get.com/2013-01-01/186.html">广西钦州保税港区欲成中国-</a></li><li><a href="http://news.v-get.com/2013-01-01/185.html">北京物流动真格，24小时监控</a></li><li><a href="http://news.v-get.com/2013-01-01/184.html">我国物流园空置率为何那么高</a></li></ul>
</div>
<div class="r3 rw mg">
<h4>|<a href="http://i.v-get.com/report/views?f=3">企业展台</a></h4>
<div class="v_t"><dl><dt><a href="http://news.v-get.com/2013-01-01/85.html"><img i="http://www.v-get.com/www.v-getimg.com/i8/70x70/281.gif" alt="中国邮政速递"></a></dt><dd><h3><a href="hhttp://news.v-get.com/2013-01-01/85.html">国际品牌 邮政速递</a></h3><p>物流“领导”品牌EMS<br>何敌UPS/DHL/TNT<br>国际物流品牌？<a href="http://news.v-get.com/2013-01-01/85.html">[详细]</a></p></dd></dl>
</div>
<div id="ar3" class="ph">
<ul>
<li>
...
J('http://www.v-get.com/www.v-getimg.com/i0/s3/abn.js');
$K(<?php echo '"',$jsk,'",',$A+2;?>);
</script>
