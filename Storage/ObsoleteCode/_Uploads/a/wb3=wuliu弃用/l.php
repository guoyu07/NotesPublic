<?php
$c=mysql_connect("localhost","wla1Ako","vgt1295EN");mysql_select_db("v3",$c);mysql_query("set names utf8"); 
$p=empty($_GET['p'])?1:$_GET['p'];$P=($p-1)*13;
?><!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"/><title>物流公司排名查询_V-Get!</title><link href="http://weigeti.com/p0/favicon.ico" type="image/ico" rel="shortcut icon"/><link rel="stylesheet" type="text/css" href="http://baike.v-get.com/f.css" /><style type="text/css">.c{padding:13px;width:616px}#m{height:28px;line-height:28px;background:#E5ECF9;border:#E5ECF9 1px solid;border-radius:3px;padding:0 9px}.pg{text-align:right;height:28px;line-height:28px}.pg a{margin:0 5px}.pg .po{color:#999;text-decoration:none}#c{padding:0 50px 0 11px;width:555px;border-top:#e5ecf9 1px solid;border-bottom:#e5ecf9 1px solid}#c a{text-decoration:underline;color:#00c}#c div{margin:15px 0}#c h2{font-size:14px;line-height:20px}#c h2 a{margin-right:15px}#c h2 a:visited{color:#810081}#c h2 span{color:#666;font-size:11px;font-weight:400}#c p{line-height:22px}#c p a{color:#7A77C8}</style></head><script type="text/javascript" src="http://weigeti.com/p0/c.js"></script><body><div class="w"><div class="t"><a href="http://www.v-get.com/">V-Get!首页</a>-<a href="http://news.v-get.com/">新闻</a>-<a href="http://baike.v-get.com/">百科</a>-<a href="http://wuliu.v-get.com/">物流</a></div><div class="n"><div class="p i"><img i="http://weigeti.com/p0/v2b.gif" /></div><div class="q s"><form action="http://www.google.com/search" target="_blank"><input name="hl" value="zh-CN" type="hidden"/><input name="domains" value="v-get.com" type="hidden"/><input name="ie" value="utf-8" type="hidden"/><select name="sitesearch"><option value="v-get.com">全网</option><option value="news.v-get.com"/>新闻</option><option value="baike.v-get.com"/>百科</option><option value="wuliu.v-get.com"/>物流</option></select><input name="q" id="sk" type="text"><input type="submit" value="搜索" class="ss" /></form></div></div><div class="o v"><div class="p l"><div class="f c"><div id="m">您的位置：<a href="http://www.v-get.com/">V-Get!首页</a>&nbsp;&gt;&nbsp;<a href="http://wuliu.v-get.com/">物流查询</a>&nbsp;&gt;&nbsp;查询列表</div>
<?php
$ry=mysql_query("SELECT COUNT(*) FROM c");
$rq=mysql_query("SELECT * FROM c ORDER BY o DESC LIMIT $P,13");
$rz=mysql_fetch_array($ry);
$Iz=$rz[0];$Pz=ceil($Iz/13);$pg='';
if($Pz>1){
$Pp=$p-1;$Pn=$p+1;
$Pq=($Pp==1)?'':'_'.$Pp;
switch ($p)
{ case 1:$pg='<div class="pg"><a class="po">首页</a><a class="po">前一页&lt;</a>第<b>1</b>页<a href="http://wuliu.v-get.com/index_2.html" target="_self">&gt;下一页</a><a href="http://wuliu.v-get.com/index_'.$Pz.'.html" target="_self">共'.$Pz.'页</a></div>';break;
 case $Pz:$pg='<div class="pg"><a href="http://wuliu.v-get.com/index_1.html" target="_self">首页</a><a href="http://wuliu.v-get.com/index_'.$Pp.'.html" target="_self">前一页&lt;</a>第<b>'.$p.'</b>页<a class="po">&gt;下一页</a><a class="po">第'.$p.'页</a></div>';break;
  default:$pg='<div class="pg"><a href="http://wuliu.v-get.com/index_1.html" target="_self">首页</a><a href="http://wuliu.v-get.com/index_'.$Pp.'.html" target="_self">前一页&lt;</a>第<b>'.$p.'</b>页<a href="http://wuliu.v-get.com/index_'.$Pn.'.html" target="_self">&gt;下一页</a><a href="http://wuliu.v-get.com/index_'.$Pz.'.html" target="_self">第'.$Pz.'页</a></div>';break;
}}
...
$I=$r['i'];$V=$r['v'];
echo '<div><h2><a href="http://wuliu.v-get.com/'.$I.'" target="_blank">'.$r['h'].'</a><span>'.$r['t'].'</span></h2>';
switch ($V)
{case 1:echo '<p>已通过个人实名认证</p>';break;
 case 2:echo '<p>已通过物流企业工商认证</p>';break;
 case 255:echo '';break;
 default:echo '<p>期待物流企业认证中...</p>';break;
}
echo '<p>'.$r['d'].'</p></div>';
}
echo '</div>'.$pg;
...
<div class="b">
<p class="f bt">
<a href="http://help.v-get.com/about.html">关于我们</a>|<a href="http://help.v-get.com/partners.html">合作伙伴</a>|<a href="#">营销中心</a>|<a href="http://help.v-get.com/contact.html">联系我们</a>|<a href="http://wuliu.v-get.com/index_1.html">网站地图</a>|<a href="#">微个体网</a>|<a href="http://help.v-get.com/copyright.html">版权声明</a>
...
</div></div><div style="display:none"><script type="text/javascript">Q();A();$("bdshell_js").src="http://bdimg.share.baidu.com/static/js/shell_v2.js?cdnversion="+new Date().getHours();var _bdhmProtocol=(("https:"==document.location.protocol)?" https://":" http://");document.write(unescape("%3Cscript src='"+_bdhmProtocol + "hm.baidu.com/h.js%3F1647779f45896943c60c75fb905f6360' type='text/javascript'%3E%3C/script%3E"));</script></div></body></html>