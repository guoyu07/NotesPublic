...
<link href="http://weigeti.com/i0/vi/r/views.css" type="text/css" rel="stylesheet" />
...
echo '<table><tr><th>排名</th><th>名称</th><th><a href="http://i.v-get.com/report/views?f=',$S,'" class="views">浏览量</a></th><th><a href="http://i.v-get.com/report/views?o=good&f=',$S,'" class="viewsgood">好评</a></th><th><a href="http://i.v-get.com/report/views?o=nogood&f=',$S,'" class="viewsnogood">差评</a></th></tr>';
while($Qa=mysql_fetch_array($Qq)){++$P;
echo '<tr><td>',$P,'</td><td><a href="http://',$Qa['h'],'</a></td><td>',$Qa['n'],'</td><td>',$Qa['g'],'</td><td>',$Qa['b'],'</td></tr>';

}
echo '<tr><td colspan="5"><a href="http://i.v-get.com/report/views?p=',$P,'&o=',$oo,'&f=',$S,'">更多排名','</a></td></tr></table>';
