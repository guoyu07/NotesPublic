...
$Qy=mysql_query('SELECT COUNT(*) FROM f2013 WHERE s=3 AND (b=330782 OR b=0) '.$QK,$Qc);
...
<div class="p c">
<div class="cs">
<form action="http://yiwuwuliu.news.v-get.com/logistics/index_1.html" id="cfs">
...
<?php 
echo '<div class="cct">|&nbsp;&nbsp;义乌物流新闻<span>约',$Qt,'个</span></div><div id="cf">';
...
$Pq=($Pp==1)?'':'_'.$Pp;
switch ($sp)
{ case 1:echo '<div class="pg"><a class="po">首页</a><a class="po">前一页&lt;</a>第<b>1</b>页<a href="http://yiwuwuliu.news.v-get.com/logistics/index_2.html',$key,'" target="_self">&gt;下一页</a><a href="http://yiwuwuliu.news.v-get.com/logistics/index_'.$Pz.'.html',$key,'" target="_self">共'.$Pz.'页</a></div>';break;
 case $Pz:echo '<div class="pg"><a href="http://yiwuwuliu.news.v-get.com/logistics/index_1.html',$key,'" target="_self">首页</a><a href="http://yiwuwuliu.news.v-get.com/logistics/index_'.$Pp.'.html',$key,'" target="_self">前一页&lt;</a>第<b>'.$sp.'</b>页<a class="po">&gt;下一页</a><a class="po">第'.$sp.'页</a></div>';break;
  default:echo '<div class="pg"><a href="http://yiwuwuliu.news.v-get.com/logistics/index_1.html',$key,'" target="_self">首页</a><a href="http://yiwuwuliu.news.v-get.com/logistics/index_'.$Pp.'.html',$key,'" target="_self">前一页&lt;</a>第<b>'.$sp.'</b>页<a href="http://yiwuwuliu.news.v-get.com/logistics/index_'.$Pn.'.html',$key,'" target="_self">&gt;下一页</a><a href="http://yiwuwuliu.news.v-get.com/logistics/index_'.$Pz.'.html',$key,'" target="_self">第'.$Pz.'页</a></div>';break;
}}
