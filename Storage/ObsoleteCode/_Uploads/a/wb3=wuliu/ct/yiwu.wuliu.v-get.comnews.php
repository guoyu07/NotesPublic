...
$Qy=mysql_query('SELECT COUNT(*) FROM f2013 WHERE (b=330782 OR b=0) '.$QK,$Qc);
...
<div class="p c">
<div class="cs">
<form action="http://yiwu.wuliu.v-get.com/news/s" id="cfs">
...
echo '<div class="cf"><h2><a href="http://wuliu.v-get.com/news/',$DT,'/',$Qa['i'],'.html">',$Qa['h'],'</a></h2><p>',$Qa['d'],'</p><div class="a cfk">';
$K=$Qa['k'];$aK=explode(' ',$K);
foreach($aK as $ka=>$KA){
echo '<a href="#">',$KA,'</a>';
}
...
$Pq=($Pp==1)?'':'_'.$Pp;
switch ($sp)
{ case 1:echo '<div class="pg"><a class="po">首页</a><a class="po">前一页&lt;</a>第<b>1</b>页<a href="http://yiwu.wuliu.v-get.com/news-2/',$key,'" target="_self">&gt;下一页</a><a href="http://yiwu.wuliu.v-get.com/news-'.$Pz.'',$key,'" target="_self">共'.$Pz.'页</a></div>';break;
 case $Pz:echo '<div class="pg"><a href="http://yiwu.wuliu.v-get.com/news/',$key,'" target="_self">首页</a><a href="http://yiwu.wuliu.v-get.com/news-'.$Pp.'/',$key,'" target="_self">前一页&lt;</a>第<b>'.$sp.'</b>页<a class="po">&gt;下一页</a><a class="po">第'.$sp.'页</a></div>';break;
  default:echo '<div class="pg"><a href="http://yiwu.wuliu.v-get.com/news/',$key,'" target="_self">首页</a><a href="http://yiwu.wuliu.v-get.com/news-'.$Pp.'/',$key,'" target="_self">前一页&lt;</a>第<b>'.$sp.'</b>页<a href="http://yiwu.wuliu.v-get.com/news-'.$Pn.'/',$key,'" target="_self">&gt;下一页</a><a href="http://yiwu.wuliu.v-get.com/news-'.$Pz.'/',$key,'" target="_self">第'.$Pz.'页</a></div>';break;
}}
