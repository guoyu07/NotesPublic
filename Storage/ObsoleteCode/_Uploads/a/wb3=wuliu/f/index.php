...
<div id="n" class="a"><?php echo '<a href="http://',$M,'.wuliu.v-get.com/" class="no">首页</a><i></i><a href="http://',$M,'.wuliu.v-get.com/logistics/about.html">公司介绍</a><i></i><a href="http://',$M,'.wuliu.v-get.com/logistics/services.html">服务项目</a><i></i><a href="http://',$M,'.wuliu.v-get.com/logistics/honor.html">企业荣誉</a><i></i><a href="http://',$M,'.wuliu.v-get.com/logistics/certificate.html">诚信认证</a><i></i><a href="http://',$M,'.wuliu.v-get.com/logistics/exhibition.html">视觉展厅</a><i></i><a href="http://',$M,'.wuliu.v-get.com/logistics/news.html">新闻公告</a><i></i><a href="http://',$M,'.wuliu.v-get.com/logistics/contact.html">联系我们</a><i></i></div><div class="bg"><script type="text/javascript">var Dd1="pics=';
$BG=$Qa['bg'];
if(isset($BG{9})){echo $BG;}
else {echo 'http://www.v-get.com/www.v-getimg.com/i1/s3/f/d/0.jpg|http://www.v-get.com/www.v-getimg.com/i1/s3/f/d/1.jpg|http://www.v-get.com/www.v-getimg.com/i1/s3/f/d/2.jpg|http://www.v-get.com/www.v-getimg.com/i1/s3/f/d/3.jpg&links=http://wuliu.v-get.com|http://wuliu.v-get.com|http://wuliu.v-get.com|http://wuliu.v-get.com';}
echo '&border=0&borderwidth=960&borderheight=350&textheight=0";</script><script src="http://www.v-get.com/www.v-getimg.com/i0/d/d1.js" type="text/javascript"></script></div>';?><div class="v"><div class="p l">
<div class="l2">
<div class="p f">
<?php echo '<div><a href="http://',$M,'.wuliu.v-get.com/logistics/services.html"><img src="http://www.v-get.com/www.v-getimg.com/i1/s3/f/l2l.jpg" width="225" height="100" alt="',$H,'服务指南"/></a></div><h2><a href="http://',$M,'.wuliu.v-get.com/logistics/services.html">我们的服务 &gt;&gt;</a></h2><p>',$Qa['e'],'...</p></div><div class="p f"><div><a href="http://',$M,'.wuliu.v-get.com/logistics/honor.html"><img src="http://www.v-get.com/www.v-getimg.com/i1/s3/f/l2c.jpg" width="225" height="100" alt="',$H,'荣誉认证"/></a></div><h2><a href="http://',$M,'.wuliu.v-get.com/logistics/honor.html">企业的荣誉 &gt;&gt;</a></h2><p>',$Qa['g'],'...</p></div><div class="p f"><div><a href="http://',$M,'.wuliu.v-get.com/logistics/about.html"><img src="http://www.v-get.com/www.v-getimg.com/i1/s3/f/l2r.jpg" width="225" height="100" alt="',$H,'的承诺"/></a></div><h2><a href="http://',$M,'.wuliu.v-get.com/logistics/about.html">我们的承诺 &gt;&gt;</a></h2><p>',$Qa['l'],'...</p></div>';?>
</div>
<div class="o mh mb"></div>
<div class="l3">
<div class="l3l p">
<div class="l3a a"><a href="http://<?php echo $M;?>.wuliu.v-get.com/logistics/contact.html" title="联系我们"></a><a href="#" title="在线留言"></a><div class="o"></div></div>
<div class="l3b">
<h4>公司简介</h4>
<p><?php echo $Qa['a'];?>...</p>
</div>
...
<ul>
<?php
$Qqn=mysql_query('SELECT * FROM news WHERE m="'.$M.'" ORDER BY top DESC LIMIT 5');
while($Qan=mysql_fetch_array($Qqn)){
$nT=$Qan['t'];$nT=explode(' ',$nT);$nT=$nT[0];
echo '<li><a href="http://',$M,'.wuliu.v-get.com/logistics/news.html?view=',$Qan['i'],'">',$Qan['h'],'</a><i class="pr">',$nT,'</i></li>';}
?>
</ul>
...
<div class="o"></div>
<div class="c_b">
<h4><a href="http://<?php echo $M;?>.wuliu.v-get.com/logistics/services.html">服务项目</a></h4>
<?php 
...
$iP=$Qai['p'];$iH=$Qai['h'];
echo '<a href="http://',$M,'.wuliu.v-get.com/logistics/exhibition.html?i=1&show=',$iP,'"><img src="http://www.v-get.com/www.v-getimg.com/i1/s3/f/205x110/',$M,'_',$iP,'.jpg" width="205" height="110" alt="',$iH,'"/><br>',$iH,'<br>',$Qai['d'],'</a>';
}

echo '</div><div class="o mh"></div><h4><a href="http://',$M,'.wuliu.v-get.com/logistics/exhibition.html">视觉展厅</a></h4><div class="a ca">';
$Qqi=mysql_query('SELECT p,h,d FROM fi WHERE m="'.$M.'" AND x=0 LIMIT 6');
while($Qai=mysql_fetch_array($Qqi)){
$iP=$Qai['p'];$iH=$Qai['h'];
echo '<a href="http://',$M,'.wuliu.v-get.com/logistics/exhibition.html?i=0&show=',$iP,'"><img src="http://www.v-get.com/www.v-getimg.com/i1/s3/f/205x110/',$M,$iP,'.jpg" width="205" height="110" alt="',$iH,'"/><br>',$iH,'<br>',$Qai['d'],'</a>';
}
