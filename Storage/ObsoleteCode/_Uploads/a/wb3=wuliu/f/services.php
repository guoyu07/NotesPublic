...
$iP=$Qai['p'];$iH=$Qai['h'];
echo '<a href="http://',$M,'.wuliu.v-get.com/logistics/exhibition.html?i=1&show=',$iP,'"><img src="http://www.v-get.com/www.v-getimg.com/i1/s3/f/205x110/',$M,'_',$Qai['p'],'.jpg" width="205" height="110" alt="',$iH,'"/><br><strong>',$iH,'</strong><br>',$Qai['d'],'</a>';
}
