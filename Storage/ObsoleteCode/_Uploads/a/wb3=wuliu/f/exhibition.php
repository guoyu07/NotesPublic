...
if($iX==0){header('Location: http://'.$M.'.wuliu.v-get.com/logistics/exhibition.html');}
else {header('Location: http://'.$M.'.wuliu.v-get.com/logistics/services.html');}
exit();}
...
$iP=$Qai['p'];$iH=$Qai['h'];
echo '<a href="http://',$M,'.wuliu.v-get.com/logistics/exhibition.html?show=',$iP,'"><img src="http://www.v-get.com/www.v-getimg.com/i1/s3/f/205x110/',$M,$Qai['p'],'.jpg" width="205" height="110" alt="',$iH,'"/><br>',$iH,'<br>',$Qai['d'],'</a>';
}
