...
$Qq=mysql_query('SELECT h,k,r,q,s,p,lw,x,y,z,t FROM ff WHERE m="'.$M.'" LIMIT 1');$Qr=mysql_num_rows($Qq);if($Qr==0){header('Location: http://wuliu.v-get.com/');exit();}
$Qa=mysql_fetch_array($Qq);
$H=$Qa['h'];$K=$Qa['k'];$Z=$Qa['z'];$LW=strlen($Qa['lw'])>0?$Qa['lw']:($M.'.wuliu.v-get.com');
echo '<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"/><title>联系我们_',$H,'_',$Z,$K,'_商务物流网_V-Get!</title><meta name="keywords" content="',$K,'" /><meta name="description" content="',$H,'联系方式。我们专注于',$Z,$Qa['r'],'"/>';?>
...
<div id="n" class="a"><?php echo '<a href="http://',$M,'.wuliu.v-get.com/">首页</a><i></i><a href="http://',$M,'.wuliu.v-get.com/logistics/about.html">公司介绍</a><i></i><a href="http://',$M,'.wuliu.v-get.com/logistics/services.html">服务项目</a><i></i><a href="http://',$M,'.wuliu.v-get.com/logistics/honor.html">企业荣誉</a><i></i><a href="http://',$M,'.wuliu.v-get.com/logistics/certificate.html">诚信认证</a><i></i><a href="http://',$M,'.wuliu.v-get.com/logistics/exhibition.html">视觉展厅</a><i></i><a href="http://',$M,'.wuliu.v-get.com/logistics/news.html">新闻公告</a><i></i><a href="http://',$M,'.wuliu.v-get.com/logistics/contact.html" class="no">联系我们</a>';?><i></i></div><div class="o mh"></div><div class="v"><div class="p l"><div class="o mh"></div>
<div class="m cc"><div>您现在的位置：<?php echo '<a href="http://',$M,'.wuliu.v-get.com/">',$H,'</a>';?> &gt; 企业荣誉</div></div>
<div class="mf"><?php echo $Qa['s'];?>
<div class="o mh"></div><div id="map"></div><script type="text/javascript" src="http://api.map.baidu.com/api?v=1.4"></script><script type="text/javascript">(function(){var m=new BMap.Map("map"),p=new BMap.Point(<?php echo $Qa['p'];?>),k=new BMap.Marker(p),w;m.centerAndZoom(p,13);m.enableScrollWheelZoom();m.addControl(new BMap.NavigationControl());m.addControl(new BMap.ScaleControl());m.addControl(new BMap.OverviewMapControl());m.addOverlay(k);<?php echo 'w=new BMap.InfoWindow(',"'",'<div class="map"><img src="http://www.v-get.com/www.v-getimg.com/i1/s3/70/',$M,'.gif" /><ul>',$Qa['r'],'<li>网　址：',$LW,'</li></ul></div>',"'",',{title:"',$H,'"});';?>k.openInfoWindow(w);k.addEventListener($7,function(){this.openInfoWindow(w);})})();</script>
</div>
</div>
<div class="q r">
