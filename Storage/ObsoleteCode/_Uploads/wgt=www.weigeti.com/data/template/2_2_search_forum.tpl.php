...
0
|| checktplrefresh('./template/pun_qingshuang/search/forum.htm', './template/pun_qingshuang/search/header.htm', 1377127584, '2', './data/template/2_2_search_forum.tpl.php', './template/pun_qingshuang', 'search/forum')
|| checktplrefresh('./template/pun_qingshuang/search/forum.htm', './template/pun_qingshuang/search/pubsearch.htm', 1377127584, '2', './data/template/2_2_search_forum.tpl.php', './template/pun_qingshuang', 'search/forum')
|| checktplrefresh('./template/pun_qingshuang/search/forum.htm', './template/pun_qingshuang/search/thread_list.htm', 1377127584, '2', './data/template/2_2_search_forum.tpl.php', './template/pun_qingshuang', 'search/forum')
|| checktplrefresh('./template/pun_qingshuang/search/forum.htm', './template/pun_qingshuang/search/footer.htm', 1377127584, '2', './data/template/2_2_search_forum.tpl.php', './template/pun_qingshuang', 'search/forum')
|| checktplrefresh('./template/pun_qingshuang/search/forum.htm', './template/default/common/header_common.htm', 1377127584, '2', './data/template/2_2_search_forum.tpl.php', './template/pun_qingshuang', 'search/forum')
;?>
...
<em>&copy; 2010-2012 <a href="<?php echo $_G['setting']['siteurl'];?>" target="_blank"><?php echo $_G['setting']['sitename'];?></a>  <?php if($_G['setting']['icp']) { ?><a href="http://www.miibeian.gov.cn/" target="_blank"><?php echo $_G['setting']['icp'];?></a><?php } ?></em>

<?php if(!empty($_G['setting']['pluginhooks']['global_footerlink'])) echo $_G['setting']['pluginhooks']['global_footerlink'];?>
<?php if($_G['setting']['statcode']) { ?><?php echo $_G['setting']['statcode'];?><?php } updatesession();?></div>
