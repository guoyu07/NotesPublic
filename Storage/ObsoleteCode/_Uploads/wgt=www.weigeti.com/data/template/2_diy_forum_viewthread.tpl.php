...
0
|| checktplrefresh('./template/pun_qingshuang/forum/viewthread.htm', './template/pun_qingshuang/common/header.htm', 1377125951, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/pun_qingshuang', 'forum/viewthread')
|| checktplrefresh('./template/pun_qingshuang/forum/viewthread.htm', './template/pun_qingshuang/forum/viewthread_node.htm', 1377125951, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/pun_qingshuang', 'forum/viewthread')
|| checktplrefresh('./template/pun_qingshuang/forum/viewthread.htm', './template/pun_qingshuang/forum/viewthread_fastpost.htm', 1377125951, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/pun_qingshuang', 'forum/viewthread')
|| checktplrefresh('./template/pun_qingshuang/forum/viewthread.htm', './template/default/common/footer.htm', 1377125951, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/pun_qingshuang', 'forum/viewthread')
|| checktplrefresh('./template/pun_qingshuang/forum/viewthread.htm', './template/default/common/header_common.htm', 1377125951, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/pun_qingshuang', 'forum/viewthread')
|| checktplrefresh('./template/pun_qingshuang/forum/viewthread.htm', './template/pun_qingshuang/common/pubsearchform.htm', 1377125951, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/pun_qingshuang', 'forum/viewthread')
|| checktplrefresh('./template/pun_qingshuang/forum/viewthread.htm', './template/pun_qingshuang/forum/viewthread_node_body.htm', 1377125951, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/pun_qingshuang', 'forum/viewthread')
|| checktplrefresh('./template/pun_qingshuang/forum/viewthread.htm', './template/default/common/seditor.htm', 1377125951, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/pun_qingshuang', 'forum/viewthread')
|| checktplrefresh('./template/pun_qingshuang/forum/viewthread.htm', './template/default/common/seccheck.htm', 1377125951, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/pun_qingshuang', 'forum/viewthread')
;?>
...
<link href="<?php echo $_G['style']['styleimgdir'];?>/portal.css" rel="stylesheet" type="text/css">
...
<div id="toptb"><?php if(!empty($_G['setting']['pluginhooks']['global_cpnav_top'])) echo $_G['setting']['pluginhooks']['global_cpnav_top'];?><?php if(!empty($_G['setting']['pluginhooks']['global_cpnav_extra1'])) echo $_G['setting']['pluginhooks']['global_cpnav_extra1'];?><?php if(!empty($_G['setting']['pluginhooks']['global_cpnav_extra2'])) echo $_G['setting']['pluginhooks']['global_cpnav_extra2'];?></div><?php echo adshow("headerbanner/wp a_h");?><div id="hd">
<div class="wp">
...
<?php } } else { if(!$_G['forum_thread']['is_archived']) { ?><a href="forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>" id="newspecial" title="发新帖">发新帖</a><?php } } ?>
</div>
...
<?php if($_G['page'] > 1 || ($rushresult['rewardfloor'] && $_GET['checkrush'])) { ?>
...
楼主: <a href="home.php?mod=space&amp;uid=<?php echo $_G['forum_thread']['authorid'];?>" title="<?php echo $_G['forum_thread']['author'];?>" class="xi2"><?php echo $_G['forum_thread']['author'];?></a>
<?php } else { ?>
楼主:
<?php if($_G['forum']['ismoderator']) { ?>
<a href="home.php?mod=space&amp;uid=<?php echo $_G['forum_thread']['authorid'];?>" class="xi2">匿名</a>
<?php } else { ?>
匿名
<?php } } ?>
</div>
...
<div class="pi">
<div class="authi xg1">
查看: <?php echo $_G['forum_thread']['views'];?>
<span class="pipe">|</span>
回复: <?php echo $_G['forum_thread']['replies'];?>
...
<table cellspacing="0" cellpadding="0" class="ad"><tr><td class="pls"></td><td class="plc"></td></tr></table><?php $postcount = 0;?><?php if(is_array($postlist)) foreach($postlist as $post) { if($rushreply && $_GET['checkrush'] && $post['rewardfloor'] != 1) { continue;?><?php } ?>
...
<div class="p_pop blk bui" id="userinfo<?php echo $post['pid'];?>" style="display: none; margin-top: -16px; margin-left: -4px;">
<div class="m z">
...
<p><a href="home.php?mod=follow&amp;do=following&amp;uid=<?php echo $post['authorid'];?>" class="xi2"><?php echo dnumber($post['following']); ?></a></p><?php echo '收听'; } else { ?>
<p><a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>&amp;do=profile" class="xi2"><?php echo dnumber($post['credits']); ?></a></p>积分
<?php } ?>
</th>
<th>
<?php if(helper_access::check_module('follow')) { ?>
...
<td><p><a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>&amp;do=thread&amp;view=me&amp;from=space" class="xi2"><?php echo dnumber($post['threads']); ?></a></p>主题</td>
</table>
</div>
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['viewthread_avatar'][$postcount])) echo $_G['setting']['pluginhooks']['viewthread_avatar'][$postcount];?>
</div>
<?php if($post['authorid'] != $_G['uid'] && $post['first']) { ?>
...
<td id="plc_<?php echo $post['pid'];?>" class="plc<?php if($_G['setting']['commentnumber'] && $comments[$post['pid']]) { ?> disp<?php } ?>">
<?php if($post['first']) { ?>
<div class="mtm pbm bbda">
<h1 class="ts">
<?php if($_G['forum_thread']['typeid'] && $_G['forum']['threadtypes']['types'][$_G['forum_thread']['typeid']]) { if(!IS_ROBOT && ($_G['forum']['threadtypes']['listable'] || $_G['forum']['status'] == 3)) { ?>
...
<?php if($post['warned']) { ?>
<a href="forum.php?mod=misc&amp;action=viewwarning&amp;tid=<?php echo $_G['tid'];?>&amp;uid=<?php echo $post['authorid'];?>" title="受到警告" class="y mtn" onclick="showWindow('viewwarning', this.href)"><img src="<?php echo IMGDIR;?>/warning.gif" alt="受到警告" /></a>
<?php } ?>
</strong>
<?php } ?>
<div class="pti">
...
<span class="pipe">|</span>
回复: <?php echo $_G['forum_thread']['replies'];?>
<?php } if(!IS_ROBOT && !$_G['forum_thread']['archiveid'] && $post['first'] ) { if($thread['authorid'] == $_G['uid']) { ?>
<span class="pipe">|</span>
...
</div><?php $ad_a_pr=adshow("thread/a_pr/3/$postcount");?><div class="pct">
...
<?php } ?><div class="pcb">
<?php if($_G['forum_thread']['replycredit'] > 0 && $post['first']) { ?>
<div class="locked replycredit">
<strong><?php echo $_G['forum_thread']['replycredit'];?> <?php echo $_G['setting']['extcredits'][$_G['forum_thread']['replycredit_rule']['extcreditstype']]['unit'];?><?php echo $_G['setting']['extcredits'][$_G['forum_thread']['replycredit_rule']['extcreditstype']]['title'];?></strong> 回复本帖可获得 <?php echo $_G['forum_thread']['replycredit_rule']['extcredits'];?> <?php echo $_G['setting']['extcredits'][$_G['forum_thread']['replycredit_rule']['extcreditstype']]['unit'];?><?php echo $_G['setting']['extcredits'][$_G['forum_thread']['replycredit_rule']['extcreditstype']]['title'];?>奖励! 每人限 <?php echo $_G['forum_thread']['replycredit_rule']['membertimes'];?> 次<?php if($_G['forum_thread']['replycredit_rule']['random'] > 0) { ?><span class="xg1">(中奖概率 <?php echo $_G['forum_thread']['replycredit_rule']['random'];?>%)</span><?php } ?>
</div>
<?php } if($rushreply && $post['first']) { ?>
<div class="locked rewardfloor">
<?php if($rushresult['rewardfloor']) { ?>
<span class="y">
<?php if($_G['uid'] == $_G['thread']['authorid'] || $_G['forum']['ismoderator']) { ?><a href="javascript:;" onclick="showWindow('membernum', 'forum.php?mod=ajax&action=get_rushreply_membernum&tid=<?php echo $_G['tid'];?>')" class="y pn xi2"><span>统计参与人数</span></a><?php } if(!$_GET['checkrush']) { ?>
...
<td>
<a href="home.php?mod=space&amp;uid=<?php echo $uid;?>" target="_blank"><?php echo $ratelog['username'];?></a>
...
<?php if($post['invisible'] == 0) { if(!empty($_G['setting']['pluginhooks']['viewthread_share_method'])) { ?>
<div class="tshare cl">
<strong>分享到:</strong>
...
<?php } ?>
<div id="p_btn">
<?php if($post['first'] && $allowpostreply && !$_G['forum_thread']['archiveid']) { ?>
<a href="javascript:;" id="post_reply" onclick="showWindow('reply', 'forum.php?mod=post&action=reply&fid=<?php echo $_G['fid'];?>&tid=<?php echo $_G['tid'];?>')" title="回复"><i><img src="<?php echo IMGDIR;?>/fastreply.gif" alt="回复" />回复</i></a>
...
<?php } if($post['first']) { if($post['signature'] && ($_G['setting']['bannedmessages'] & 4 && ($post['memberstatus'] == '-1' || ($post['authorid'] && !$post['username']) || ($post['groupid'] == 4 || $post['groupid'] == 5) || ($post['status'] & 1)))) { ?>
...
<div id="po_<?php echo $post['pid'];?>" class="po">
...
<?php } if($post['first'] && $allowblockrecommend) { ?><a href="javascript:;" onclick="modaction('recommend', '<?php echo $_G['forum_firstpid'];?>', 'op=recommend&idtype=<?php if($_G['forum_thread']['isgroup']) { ?>gtid<?php } else { ?>tid<?php } ?>&id=<?php echo $_G['tid'];?>&pid=<?php echo $post['pid'];?>', 'portal.php?mod=portalcp&ac=portalblock')">推送</a><?php } if($post['first']) { ?><a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=thread&amp;id=<?php echo $_G['tid'];?>" id="k_favorite" onclick="showWindow(this.id, this.href, 'get', 0);">收藏<span id="favoritenumber" style="display: none;">0</span></a><?php } if((($_G['forum']['ismoderator'] && $_G['group']['alloweditpost'] && (!in_array($post['adminid'], array(1, 2, 3)) || $_G['adminid'] <= $post['adminid'])) || ($_G['forum']['alloweditpost'] && $_G['uid'] && ($post['authorid'] == $_G['uid'] && $_G['forum_thread']['closed'] == 0) && !(!$alloweditpost_status && $edittimelimit && TIMESTAMP - $post['dbdateline'] > $edittimelimit)))) { ?>
...
<a href="forum.php?mod=misc&amp;action=postappend&amp;tid=<?php echo $post['tid'];?>&amp;pid=<?php echo $post['pid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;page=<?php echo $page;?>" onclick="showWindow('postappend', this.href, 'get', 0)">补充</a>
<?php } if($post['invisible'] == 0) { if($allowpostreply && $post['allowcomment'] && (!$thread['closed'] || $_G['forum']['ismoderator'])) { ?>
<a href="forum.php?mod=misc&amp;action=comment&amp;tid=<?php echo $post['tid'];?>&amp;pid=<?php echo $post['pid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;page=<?php echo $page;?><?php if($_G['forum_thread']['special'] == 127) { ?>&amp;special=<?php echo $specialextra;?><?php } ?>&amp;handlekey=comment" id="cmtsbtn_<?php echo $post['pid'];?>" onclick="display('cmtform_<?php echo $post['pid'];?>'); !$('cmtform_<?php echo $post['pid'];?>').innerHTML && ajaxget(this.href, 'cmtform_<?php echo $post['pid'];?>'); return false;"<?php if($_G['setting']['commentnumber'] && !empty($comments[$post['pid']])) { ?> class="a"<?php } ?>>点评</a>
<?php } else { if($_G['setting']['commentnumber'] && !empty($comments[$post['pid']])) { ?>
<a href="javascript:;" class="a">点评</a>
<?php } } if((!$_G['uid'] || $allowpostreply) && !$needhiddenreply) { if($post['first']) { ?>
<a href="forum.php?mod=post&amp;action=reply&amp;fid=<?php echo $_G['fid'];?>&amp;tid=<?php echo $_G['tid'];?>&amp;reppost=<?php echo $post['pid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;page=<?php echo $page;?>" onclick="showWindow('reply', this.href)">回复</a>
<?php } else { ?>
<a href="forum.php?mod=post&amp;action=reply&amp;fid=<?php echo $_G['fid'];?>&amp;tid=<?php echo $_G['tid'];?>&amp;repquote=<?php echo $post['pid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;page=<?php echo $page;?>" onclick="showWindow('reply', this.href)">回复</a>
...
<?php } if($post['authorid'] && !$post['anonymous']) { if(!IS_ROBOT && !$_GET['authorid'] && !$_G['forum_thread']['archiveid']) { ?>
...
<a href="javascript:;" id="mgc_post_<?php echo $post['pid'];?>" class="showmenu" onmouseover="showMenu(this.id)">道具</a>
...
<?php } ?>
<div id="comment_<?php echo $post['pid'];?>"><?php if($_G['setting']['commentnumber'] && !empty($comments[$post['pid']])) { ?><div class="cmtl xld xlda">
<?php if($totalcomment[$post['pid']]) { ?><div class="mbm"><?php echo $totalcomment[$post['pid']];?></div><?php } if(is_array($comments[$post['pid']])) foreach($comments[$post['pid']] as $comment) { ?><dl class="cl">
<dd class="m"><a href="home.php?mod=space&amp;uid=<?php echo $comment['authorid'];?>"><?php echo $comment['avatar'];?></a></dd>
<dt>
...
<?php } ?>
<span class="xg1">
发表于 <?php echo dgmdate($comment[dateline], 'u');?><?php if($comment['useip'] && $_G['group']['allowviewip']) { ?>&nbsp;IP:<?php echo $comment['useip'];?><?php } if($comment['rpid']) { ?>
&nbsp;<a href="forum.php?mod=redirect&amp;goto=findpost&amp;pid=<?php echo $comment['rpid'];?>&amp;ptid=<?php echo $_G['tid'];?>">详情</a>
&nbsp;<a href="forum.php?mod=post&amp;action=reply&amp;fid=<?php echo $_G['fid'];?>&amp;tid=<?php echo $_G['tid'];?>&amp;repquote=<?php echo $comment['rpid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;page=<?php echo $page;?><?php if($_GET['from']) { ?>&amp;from=<?php echo $_GET['from'];?><?php } ?>" onclick="showWindow('reply', this.href)">回复</a>
<?php } if($_G['forum']['ismoderator'] && $_G['group']['allowdelpost']) { ?>&nbsp;<a href="javascript:;" onclick="modaction('delcomment', <?php echo $comment['id'];?>)">删除</a><?php } ?>
</span>
</dt>
<dd><?php echo $comment['comment'];?></dd>
</dl>
<?php } if($allowpostreply && $post['allowcomment'] && (!$thread['closed'] || $_G['forum']['ismoderator']) || $commentcount[$post['pid']] > $_G['setting']['commentnumber']) { ?>
<div class="mtm cl">
<?php if($allowpostreply && $post['allowcomment'] && (!$thread['closed'] || $_G['forum']['ismoderator'])) { ?><a href="forum.php?mod=misc&amp;action=comment&amp;tid=<?php echo $post['tid'];?>&amp;pid=<?php echo $post['pid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;page=<?php echo $page;?><?php if($_G['forum_thread']['special'] == 127) { ?>&amp;special=<?php echo $specialextra;?><?php } ?>&amp;handlekey=comment" onclick="display('cmtform_<?php echo $post['pid'];?>'); !$('cmtform_<?php echo $post['pid'];?>').innerHTML && ajaxget(this.href, 'cmtform_<?php echo $post['pid'];?>'); return false;" class="y pn"><span><?php echo '我来点评一句'; ?></span></a><?php } if($commentcount[$post['pid']] > $_G['setting']['commentnumber']) { ?><div class="pgs cl"><div class="pg"><a href="javascript:;" class="nxt" onclick="ajaxget('forum.php?mod=misc&action=commentmore&tid=<?php echo $post['tid'];?>&pid=<?php echo $post['pid'];?>&page=2', 'comment_<?php echo $post['pid'];?>')">下一页</a></div></div><?php } ?>
</div>
<?php } ?>
</div><?php } ?><div id="cmtform_<?php echo $post['pid'];?>"></div></div>
</td>
</tr>
<tr class="ad">
<td class="pls"></td>
<td class="plc">
<?php if($post['first'] && ((!$rushreply && $_G['forum_thread']['replies'] > 1) || ($post['first'] && $_G['forum_thread']['special'] == 5 && $_G['forum_thread']['displayorder'] >= 0))) { ?>
<ul class="ttp cl">
<?php if(!$rushreply && $_G['forum_thread']['replies'] > 1) { ?>
<li<?php if($ordertype != 1) { ?> class="xw1 a"<?php } ?>><a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;ordertype=2">正序浏览</a></li>
<li<?php if($ordertype == 1) { ?> class="xw1 a"<?php } ?>><a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;ordertype=1">倒序浏览</a></li>
<?php } if($_G['forum_thread']['special'] == 5 && $_G['forum_thread']['displayorder'] >= 0) { ?>
<li style="display:inline;"><strong class="bw0 bg0_all">按立场筛选: </strong></li>
...
<?php if($post['first'] && $sticklist) { if(is_array($sticklist)) foreach($sticklist as $rpost) { ?><table cellspacing="0" cellpadding="0" class="rpost mbm">
<tr>
<td class="pls">
<div class="avatar"><a href="home.php?mod=space&amp;uid=<?php echo $rpost['authorid'];?>"><?php echo avatar($rpost[authorid], middle);?></a></div>
<div class="pi"><div class="authi"><a href="home.php?mod=space&amp;uid=<?php echo $rpost['authorid'];?>" target="_blank" class="xw1"><?php echo $rpost['author'];?></a></div></div>
</td>
<td class="plc">
<div class="pi xg1">
回帖推荐: <a href="javascript:;" onclick="window.open('forum.php?mod=redirect&goto=findpost&ptid=<?php echo $rpost['tid'];?>&pid=<?php echo $rpost['pid'];?>')">查看楼层</a><?php if($_G['group']['allowstickreply'] || $_G['forum_thread']['authorid'] == $_G['uid']) { ?><span class="pipe">|</span><a href="javascript:;" onclick="modaction('stickreply', <?php echo $rpost['pid'];?>, '&undo=yes')">解除置顶</a><?php } ?>
</div>
<div class="pct"><div class="pcb"><div class="t_fsz">
<table cellspacing="0" cellpadding="0"><tr><td class="t_f" id="rpostmessage_<?php echo $rpost['pid'];?>"><?php echo $rpost['message'];?></td></tr></table>
</div></div></div>
</td>
</tr>
</table>
...
<?php if($multipage && $page < $_G['setting']['threadmaxpages'] && $page < $_G['page_next']) { $nxtpage = $page + 1;?><table cellspacing="0" cellpadding="0" class="ad">
<tr>
<td class="pls"></td>
<td class="plc">
<div class="pgbtn"><a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?><?php if($_GET['authorid']) { ?>&amp;authorid=<?php echo $_GET['authorid'];?><?php } ?>&amp;page=<?php echo $nxtpage;?>" hidefocus="true">下一页 &raquo;</a></div>
</td>
</tr>
</table>
<?php } ?>
...
<tr>
<td class="pls">
<div class="avatar"><?php echo avatar($_G['uid']); ?></div>
...
<?php } $highlights = explode(' ', str_replace('\'', '&#039;', $_GET['highlight']));?><?php if(is_array($highlights)) foreach($highlights as $word) { $key++;?>relatedlink[<?php echo $key;?>] = {'sname':'<?php echo $word;?>', 'surl':''};
<?php } ?>
