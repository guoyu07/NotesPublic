...
0
|| checktplrefresh('./template/pun_qingshuang/common/header.htm', './template/default/common/header_common.htm', 1377124066, '2', './data/template/2_2_common_header_home_space.tpl.php', './template/pun_qingshuang', 'common/header_home_space')
|| checktplrefresh('./template/pun_qingshuang/common/header.htm', './template/pun_qingshuang/common/pubsearchform.htm', 1377124066, '2', './data/template/2_2_common_header_home_space.tpl.php', './template/pun_qingshuang', 'common/header_home_space')
;?>
