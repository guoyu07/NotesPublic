...
0
|| checktplrefresh('./template/pun_qingshuang/common/header.htm', './template/default/common/header_common.htm', 1377123007, '2', './data/template/2_2_common_header.tpl.php', './template/pun_qingshuang', 'common/header')
|| checktplrefresh('./template/pun_qingshuang/common/header.htm', './template/pun_qingshuang/common/pubsearchform.htm', 1377123007, '2', './data/template/2_2_common_header.tpl.php', './template/pun_qingshuang', 'common/header')
;?>
