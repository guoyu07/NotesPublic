...
0
|| checktplrefresh('./template/pun_qingshuang/common/header.htm', './template/default/common/header_common.htm', 1377125974, '2', './data/template/2_2_common_header_misc_tag.tpl.php', './template/pun_qingshuang', 'common/header_misc_tag')
|| checktplrefresh('./template/pun_qingshuang/common/header.htm', './template/pun_qingshuang/common/pubsearchform.htm', 1377125974, '2', './data/template/2_2_common_header_misc_tag.tpl.php', './template/pun_qingshuang', 'common/header_misc_tag')
;?>
