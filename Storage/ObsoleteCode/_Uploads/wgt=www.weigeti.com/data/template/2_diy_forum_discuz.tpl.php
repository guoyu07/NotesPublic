...
0
|| checktplrefresh('./template/pun_qingshuang/forum/discuz.htm', './template/pun_qingshuang/common/header.htm', 1377122137, 'diy', './data/template/2_diy_forum_discuz.tpl.php', './template/pun_qingshuang', 'forum/discuz')
|| checktplrefresh('./template/pun_qingshuang/forum/discuz.htm', './template/default/common/footer.htm', 1377122137, 'diy', './data/template/2_diy_forum_discuz.tpl.php', './template/pun_qingshuang', 'forum/discuz')
|| checktplrefresh('./template/pun_qingshuang/forum/discuz.htm', './template/default/common/header_common.htm', 1377122137, 'diy', './data/template/2_diy_forum_discuz.tpl.php', './template/pun_qingshuang', 'forum/discuz')
|| checktplrefresh('./template/pun_qingshuang/forum/discuz.htm', './template/pun_qingshuang/common/pubsearchform.htm', 1377122137, 'diy', './data/template/2_diy_forum_discuz.tpl.php', './template/pun_qingshuang', 'forum/discuz')
;?>
...
<div class="fl mtm">
<?php if(empty($gid) && !empty($forum_favlist)) { $forumscount = count($forum_favlist);?><?php $forumcolumns = 3;?><?php $forumcolwidth = (floor(100 / $forumcolumns) - 0.1).'%';?><div class="bm bmw flg cl">
<div class="bm_h cl">
...
<tr><?php $favorderid = 0; $i = 1;?><?php if(is_array($forum_favlist)) foreach($forum_favlist as $key => $favorite) { if($favforumlist[$favorite['id']]) { $forum=$favforumlist[$favorite[id]];?><?php $forumurl = !empty($forum['domain']) && !empty($_G['setting']['domain']['root']['forum']) ? 'http://'.$forum['domain'].'.'.$_G['setting']['domain']['root']['forum'] : 'forum.php?mod=forumdisplay&fid='.$forum['fid'];?><?php if($forumcolumns>0) { if($favorderid && ($favorderid % $forumcolumns == 0)) { ?>
</tr>
...
<?php echo $forum['icon'];?>
<?php } else { ?>
<a href="<?php echo $forumurl;?>"<?php if($forum['redirect']) { ?> target="_blank"<?php } ?>><img src="<?php echo $_G['style']['styleimgdir'];?>/0<?php echo $i;?>.png" alt="<?php echo $forum['name'];?>" /></a><?php $i >= 9 ? $i = 1 : $i++;?><?php } ?>
</div>
...
<dd class="xg1">
<?php if(!$forum['redirect']) { ?><em<?php if($forum['todayposts']) { ?> class="xi1"<?php } ?>><span class="t">今日:</span><?php if($forum['todayposts']) { ?><?php echo $forum['todayposts'];?><?php } else { ?>0<?php } ?></em><?php } if($forum['permission'] == 1) { ?>
私密版块
<?php } else { ?>
<em class="l">
...
<div class="bbs_title">
<?php if($cat['moderators']) { ?><span class="y">分区版主: <?php echo $cat['moderators'];?></span><?php } $caturl = !empty($cat['domain']) && !empty($_G['setting']['domain']['root']['forum']) ? 'http://'.$cat['domain'].'.'.$_G['setting']['domain']['root']['forum'] : '';?><h2><a href="<?php if(!empty($caturl)) { ?><?php echo $caturl;?><?php } else { ?>forum.php?gid=<?php echo $cat['fid'];?><?php } ?>" class="xs2" style="<?php if($cat['extra']['namecolor']) { ?>color: <?php echo $cat['extra']['namecolor'];?>;<?php } ?>"><?php echo $cat['name'];?></a></h2>
</div>
