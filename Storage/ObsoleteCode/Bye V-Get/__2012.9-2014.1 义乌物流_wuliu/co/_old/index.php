...
$Qq=mysql_query('SELECT h,he,k,m,d,a,g,l,r,q,lk,lt,x,y,z,t,adt,bg FROM co WHERE e="'.$E.'" LIMIT 1');
$Qr=mysql_num_rows($Qq);if($Qr==0){header('Location: http://wuliu.v-get.com/');exit();}
$Qa=mysql_fetch_array($Qq);
$H=$Qa['h'];$K=$Qa['k'];$Z=$Qa['z'];
$LT=$Qa['lt'];
$TA=$Qa['adt']; /* 时间戳的int格式，便于和time()比较 */
$now=time();
$ad=($TA>$now)?false:true;  /* $ad=true 表示有广告 */
echo '<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"/><title>',$H,'主营',$Z,$ad?'_商务物流网_V-Get!':'','</title><meta name="keywords" content="',$K,'" /><meta name="description" content="',$Qa['d'],'"/>';?>
...
<div id="mc"><ul><li><img src="http://localhost/tp.v-get.com/j/3/co/960x350/1.jpg" alt="E维科技，卓越的网站开发能力_V-Get!"/></li><li><img src="http://localhost/tp.v-get.com/j/3/co/960x350/3.jpg" alt="E维科技，互联网营销专家_V-Get!"/></li><li><img src="http://localhost/tp.v-get.com/j/3/co/960x350/4.jpg" alt="E维科技，专注于互联网营销_V-Get!"/></li><li><img src="http://localhost/tp.v-get.com/j/3/co/960x350/2.jpg" alt="E维科技，营销不是你想的那么简单_V-Get!"/></li><li><img src="http://localhost/tp.v-get.com/j/3/co/960x350/5.jpg" alt="E维科技，不一样的优化推广_V-Get!"/></li></ul><div id="mco" class="a"><a class="mco">1</a><a>2</a><a>3</a><a>4</a><a>5</a></div>
</div>
</div>
...
<div class="r2">
<div class="p ff">
<?php echo '<div><a href="http://',$E,'.wuliu.v-get.com/logistics/services.html"><img src="http://localhost/tp.v-get.com/j/3/co/l2l.jpg" width="225" height="100" alt="',$H,'服务指南"/></a></div><h2><a href="http://',$E,'.wuliu.v-get.com/logistics/services.html">我们的服务 &gt;&gt;</a></h2><p>',$Qa['m'],'...</p></div><div class="p ff r2c"><div><a href="http://',$E,'.wuliu.v-get.com/logistics/honor.html"><img src="http://localhost/tp.v-get.com/j/3/co/l2c.jpg" width="225" height="100" alt="',$H,'荣誉认证"/></a></div><h2><a href="http://',$E,'.wuliu.v-get.com/logistics/honor.html">企业的荣誉 &gt;&gt;</a></h2><p>',$Qa['g'],'...</p></div><div class="q ff"><div><a href="http://',$E,'.wuliu.v-get.com/logistics/about.html"><img src="http://localhost/tp.v-get.com/j/3/co/l2r.jpg" width="225" height="100" alt="',$H,'的承诺"/></a></div><h2><a href="http://',$E,'.wuliu.v-get.com/logistics/about.html">我们的承诺 &gt;&gt;</a></h2><p>',$Qa['l'],'...</p></div>';?>
</div>
<div class="o mh mb"></div>
<div class="r3 ff">
<div class="r3l p">
<div class="r3a a"><a href="http://localhost/<?php echo $E;?>.wuliu.v-get.com/logistics/contact.html" title="联系我们"></a><a href="#" title="在线留言"></a><div class="o"></div></div>
<div class="r3b">
<h4>公司简介</h4>
<p><?php echo $Qa['a'];?>...</p>
</div>
...
<?php
$RTD='';$RTT='';
$Qqn=mysql_query('SELECT tid,subject,lastpost FROM dz_forum_thread WHERE author="'.$E.'" ORDER BY lastpost DESC LIMIT 5');
while($Qan=mysql_fetch_array($Qqn)){
$nT=$Qan['lastpost'];$nTt=strtotime($nT);$nT=date('Y-m-d',$nTt);
...
<div class="o mh"></div>
<div class="c_b">
<h4><a href="http://localhost/<?php echo $E;?>.wuliu.v-get.com/logistics/services.html">服务项目</a></h4>
<?php 

echo '<div class="a ca">';
$Qqi=mysql_query('SELECT p,h,d FROM coi WHERE e="'.$E.'" AND x=1 LIMIT 6');
while($Qai=mysql_fetch_array($Qqi)){
$iP=$Qai['p'];$iH=$Qai['h'];
echo '<a href="http://localhost/',$E,'.wuliu.v-get.com/logistics/exhibition.html?i=1&show=',$iP,'"><img src="http://localhost/tp.v-get.com/j/3/co/205x110/',$E,'_',$iP,'.jpg" width="205" height="110" alt="',$iH,'"/><br>',$iH,'<br>',$Qai['d'],'</a>';
}

echo '</div><div class="o mh"></div><h4><a href="http://localhost/',$E,'.wuliu.v-get.com/logistics/exhibition.html">视觉展厅</a></h4><div class="a ca">';
$Qqi=mysql_query('SELECT p,h,d FROM coi WHERE e="'.$E.'" AND x=0 LIMIT 6');
while($Qai=mysql_fetch_array($Qqi)){
$iP=$Qai['p'];$iH=$Qai['h'];
echo '<a href="http://localhost/',$E,'.wuliu.v-get.com/logistics/exhibition.html?i=0&show=',$iP,'"><img src="http://localhost/tp.v-get.com/j/3/co/205x110/',$E,$iP,'.jpg" width="205" height="110" alt="',$iH,'"/><br>',$iH,'<br>',$Qai['d'],'</a>';
}

echo '</div><div class="o"></div>';?>

</div></div>
<div class="q l"><div class="ff l1"><h2><?php echo '<a href="http://localhost/',$E,'.wuliu.v-get.com/">',$H,'</a>';?></h2><ul><?php echo '<li>企业名称：',$H,'</li><li>法人代表：<a href="http://',$E,'.wuliu.v-get.com/logistics/contact.html">',$Qa['x'],'</a>　<span q="',$Qa['q'],'"></span></li><li>物流性质：',$Qa['y'],'</li><li>经营范围：',$Z,'</li><li>注册时间：',$Qa['t'],'</li>';?></ul><div class="l1c"><a href="#">企业工商认证</a></div><h6>行业资质：</h6><p>海运货运代理 空运货运代理 陆运公司 报关行 理货公司 航空公司 港务局（码头） 散杂租船代理 船代公司 快递公司 仓储公司 场站 集装箱船公司 散杂货船东 其他物流供应商</p><div class="fo"><?php echo '<a href="http://',$E,'.wuliu.v-get.com/" rel="sidebar" class="ig">收藏本站</a>';?></div></div><div id="bdshare"></div><div class="l2"><ul><?php echo '<li class="r2t"><a href="http://localhost/',$E,'.wuliu.v-get.com/logistics/certificate.html"><span>企业认证</span> &nbsp; Authenticate</a></li><li><a href="http://localhost/',$E,'.wuliu.v-get.com/logistics/services.html"><span>公司业务</span> &nbsp; Our Services</a></li><li><a href="http://localhost/',$E,'.wuliu.v-get.com/logistics/faq.html"><span>常见问题</span> &nbsp; F.A.Q</a></li><li><a href="#"><span>最新公告</span> &nbsp; BBS &amp; News</a></li>';?></ul></div><?php echo $ad?'<div class="a200x200"></div>':'';?><div class="ff l3"><h4>联系我们</h4><ul><?php echo '<li>公　司：',$H,'</li>',$Qa['r'],'<li>即时通：<span q="',$Qa['q'],'"></span></li><li>网　址：<a href="http://',$E,'.wuliu.v-get.com/">',$E,'.wuliu.v-get.com</a></li>';?></ul></div></div>


<div class="o mh mg"></div><div class="vb"><div class="vbt po f"><?php echo '<a href="http://',$E,'.wuliu.v-get.com/logistics/contact.html" class="vba">友情链接</a><a href="http://',$E,'.wuliu.v-get.com/logistics/contact.html" class="pr mr">申请换链 &#8482;</a>';?></div><div class="vbc"><a href="http://wuliu.v-get.com/">商务物流网</a><?php echo $LT,$Qa['lk'];?></div></div>
</div>
