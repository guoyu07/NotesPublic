...
if($iX==0){header('Location: http://localhost/'.$E.'.wuliu.v-get.com/logistics/exhibition.html');}
else {header('Location: http://localhost/'.$E.'.wuliu.v-get.com/logistics/services.html');}
exit();}
$Qqi=mysql_query('SELECT * FROM coi WHERE e="'.$E.'" AND p='.$iP.' AND x='.$iX.' LIMIT 1');
...
<div id="n"><div class="a na"><?php echo '<a href="http://localhost/',$E,'.wuliu.v-get.com/">首页</a><i></i><a href="http://localhost/',$E,'.wuliu.v-get.com/logistics/about.html">关于我们</a><i></i><a href="http://localhost/',$E,'.wuliu.v-get.com/logistics/services.html">服务项目</a><i></i><a href="http://localhost/',$E,'.wuliu.v-get.com/logistics/honor.html">企业荣誉</a><i></i><a href="http://localhost/',$E,'.wuliu.v-get.com/logistics/certificate.html">诚信认证</a><i></i><a href="http://localhost/',$E,'.wuliu.v-get.com/logistics/exhibition.html" class="no">视觉展厅</a><i></i><a href="http://localhost/',$E,'.wuliu.v-get.com/logistics/news.html">新闻公告</a><i></i><a href="http://localhost/',$E,'.wuliu.v-get.com/logistics/faq.html">常见问题</a><i></i><a href="http://localhost/',$E,'.wuliu.v-get.com/logistics/contact.html">联系我们</a><i></i>';?></div></div><div class="o mh"></div><div class="v"><div class="q r"><div class="o mh"></div>
<div class="m cc"><div>您现在的位置：<?php echo '<a href="http://',$E,'.wuliu.v-get.com/">',$H,'</a>';?> &gt; 视觉展厅</div></div>

<?php 
//如果为空，那么就是显示图册

if($bl){
echo '<div class="cc cit"><h2>',$iH,'</h2></div><div class="po ii f"><div class="iii ho"><img src="http://localhost/tp.v-get.com/j/3/co/600/',$E,$IX,$iP,'.jpg" alt="',$iD,'"/></div><div class="iia pr a"><a href="http://localhost/',$E,'.wuliu.v-get.com/logistics/exhibition.html?i=',$iX,'&show=',($iP-1),'" class="iil" target="_self"></a><a href="http://localhost/',$E,'.wuliu.v-get.com/logistics/exhibition.html?i=',$iX,'&show=',($iP+1),'" class="iir" target="_self"></a><div class="o"></div></div></div><div class="o mh"></div><div class="cib"><p>',$iD,'</p></div>';

}
else {

echo '<div class="a ca">';
$Qqi=mysql_query('SELECT * FROM coi WHERE e="'.$E.'" AND x=0');
while($Qai=mysql_fetch_array($Qqi)){
$iP=$Qai['p'];$iH=$Qai['h'];
echo '<a href="http://localhost/',$E,'.wuliu.v-get.com/logistics/exhibition.html?show=',$iP,'"><img src="http://localhost/tp.v-get.com/j/3/co/205x110/',$E,$Qai['p'],'.jpg" width="205" height="110" alt="',$iH,'"/><br>',$iH,'<br>',$Qai['d'],'</a>';
}
