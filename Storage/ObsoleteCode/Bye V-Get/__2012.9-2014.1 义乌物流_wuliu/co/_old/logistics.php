...
$Qq=mysql_query('SELECT fi.h AS ih,fi.p AS ip,fi.x AS ix,ff.h,ff.k,ff.d,ff.a,ff.e,ff.g,ff.r,ff.q,ff.lw,ff.x,ff.y,ff.z,ff.t FROM ff LEFT JOIN fi ON ff.m=fi.m WHERE ff.m="'.$E.'"');$Qr=mysql_num_rows($Qq);if($Qr==0){header('Location: http://wuliu.v-get.com/');exit();}
