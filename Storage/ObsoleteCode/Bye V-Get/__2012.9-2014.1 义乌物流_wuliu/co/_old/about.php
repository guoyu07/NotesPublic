...
$Qq=mysql_query('SELECT h,he,k,a,i,r,q,lt,x,y,z,t,adt FROM co WHERE e="'.$E.'" LIMIT 1');$Qr=mysql_num_rows($Qq);
if($Qr==0){header('Location: http://wuliu.v-get.com/');exit();}
$Qa=mysql_fetch_array($Qq);
$H=$Qa['h'];$K=$Qa['k'];$Z=$Qa['z'];
$LT=$Qa['lt'];$TA=$Qa['adt'];$now=time();$ad=($TA>$now)?false:true;
...
</div><div class="q r"><div class="o mh"></div>
<div class="m cc"><div>您现在的位置：<?php echo '<a href="http://',$E,'.wuliu.v-get.com/">',$H,'</a>';?> &gt; 关于我们</div></div>
<div class="mf">
<div class="ct1">
<?php 
...
echo '</div><div class="cfi p"><img src="http://localhost/tp.v-get.com/j/3/co/300x200/',$E,'.jpg" width="300" height="200" alt="',$cH,'" /></div>',$Qa['i'];?>
</div>
</div>
<div class="o mh"></div>
</div>
