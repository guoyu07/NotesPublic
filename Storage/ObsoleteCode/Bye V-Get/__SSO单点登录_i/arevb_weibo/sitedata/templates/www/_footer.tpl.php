...
<script src="<?=$siteurl?>public/js/popwin.js" type="text/javascript"></script>
...
$.post("<? echo miniurl('note'); ?>/"+nid+"/del", {submit_post:1}, function(data){
data = eval('('+data+')');
if (data.success)
{
$("#post_"+nid).fadeOut();
...
pop_win.load("<? echo miniurl('pms/send?uid='); ?>"+$(this).attr('r'));
});
