...
<link href="http://localhost/www.v-get.com/i0/vi/e/sign.css" type="text/css" rel="stylesheet" />
<script type="text/javascript" src="http://localhost/www.v-get.com/i0/c.js"></script>
</head>
<body>
<!--模仿微博，首页就是登录，以后所有评论都是微博
...
<div class="l p">
<!--激活码采用邮箱/手机数字，不需要图片验证码-->

<form action="SignUpNotify?lk=<?php echo urlencode('http://www.v-get.com/');?>" method="post" id="s">
<!--个人用户禁止使用 “公司”等结尾，禁止以“中国”、“中华”开头-->
...
<!--<div><i>*</i><label>手机</label><input type="text" name="sm" value="18702159798" size="13"/></div>-->
...
<!--$_SESSION['vc'] 所有激活码，验证码都是 vc-->
<!--邮箱注册，可以直接在session里面保留数据信息，提交后保存在session里-->
...
<div class="s"><label><i>*</i>验证码：</label><input type="text" name="svc" class="svc" maxlength="4"/><span id="svi"><img src="http://localhost/i.v-get.com/j/svc?r=<?php echo time();?>" /></span><span></span><div class="o"></div></div>
<div class="o mh"></div>
...
<script type="text/javascript" src="http://localhost/www.v-get.com/i0/l.js"></script>
<script type="text/javascript">

E($('svi'),$7,function(){var d=new Date();$('^img',this)[0].src='http://localhost/i.v-get.com/j/svc?r='+d.getTime();});
...
F(a,function(o,i){
for(var r=0;r<3;r++)D(n(o,r));/*必须添加这句，否则即使是在css页写了display:none也无法调用*/
...
$A('http://localhost/www.v-get.com/i/j/SignUp_check','&su='+u.value,0,function(h){
if(h==1||h=='1'){D(n(u,2));D(n(u,3),1)}else $A('http://localhost/www.v-get.com/i/j/SignUp_check','&se='+e.value,0,function(h){if(h==1||h=='1'){D(n(e,2));D(n(e,3),1)}else s.submit()});
});

//这是ajax，所以必须要用submit内部才行，否则无效
