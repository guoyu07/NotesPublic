...
<div class="o v">
<div class="p l lt"><h2>虚拟充值、卡务票务</h2><h3>即日直充</h3><ul><li><a href="">彩票</a><a href="">充值卡</a></li><li><a href="">游戏</a><a href="">门票</a></li></ul><h3>包年包月</h3><ul><li><a href="">房屋出租</a><a href="">酒店包年</a></li><li><a href="">健身年卡</a><a href="">酒吧夜总会</a></li></ul><h3>生活娱乐</h3><ul><li><a href="">酒店预订</a><a href="">餐厅雅座</a></li><li><a href="">KTV包间</a><a href="">酒吧夜总会</a></li><li><a href="">租车服务</a><a href="">汽车票</a></li><li><a href="">机票</a><a href="">火车票</a></li><li><a href="">健身房</a><a href="">火车票</a></li></ul></div>
...
<div class="rgt">
<ul>
<li>商品编码：<?php echo $A.$i;$S=$tr['s'];if($S>0){echo '<a href="">(本商品由第三方卖家提供)</a>';}?></li>
<li>微&nbsp;商&nbsp;价：<?php echo '<b class="f9">￥'.$tr['p'].'</b><span class="f3">&nbsp;/&nbsp;'.$tr['u'].'</span>';?></li>
<li>商品评分：<span class="rgi"><span></span><a href="">(点击查看评价)</a></span></li>
<li>优惠促销：<span class="f9">返还VG金￥<?php echo $tr['o'];?></span></li>
<li>注意事项：酒店等娱乐服务一份为一天</li>
</ul>
</div>
<div class="rgb">
<form action="http://localhost:8080/v-get.com/shop/o.php" method="post">
<?php echo $tr['l'];?>
<p><input type="hidden" value="3323" name="i" /><input type="hidden" value="海信（Hisense）LED39K200 39英寸 窄边节能LED电视（黑色）" name="n" /><input type="hidden" value="2999.00" name="p" /><input type="hidden" name="j" value="0" /><input type="hidden" name="b" value="0" />我要买：<a href="javascript:void(0)" class="rga" onclick="var k=$i($('rk').value);if(k>1)$('rk').value=k-1;">-</a><input type="text" value="1" name="m" id="rk"/><a href="javascript:void(0)" class="rga" onclick="var k=$i($('rk').value);$('rk').value=k+1;">+</a><span class="rd">起始日期：<input type="text" value="2012-05-08" id="rd"/> 周四</span><!--没有终止时间，只有起始时间，这样利于年卡 季卡等--></p>
<p class="rgbb"><input type="submit" value="加入V购车" class="rs rs1"/><a href="">收藏</a><span class="f3">(已有119人收藏)</span></p>
</form>
</div>
</div>
...
<ul>
<li>产品名称：<?php echo $h;?></li>
<li>入驻时间：<?php echo $tr['t'];?></li>
</ul>
</div>
<div class="cb">
<?php echo $tr['f'];?>
