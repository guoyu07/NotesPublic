...
<table id="a">
<tr><th width="100">收货人信息</th><th><a href="http://没有js时修改收货人" onclick="javascipt:a(this);return false">[修改]</a></th></tr>
<tr><td class="q">收货人姓名：</td><td><input type="text" value="'.$_SESSION['mn'].'" name="mn"/></td></tr>
<tr><td class="q">地&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;址：</td><td><input type="text" value="'.$_SESSION['md'].'" class="sa" name="md" /></td></tr>
<tr><td class="q">手&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;机：</td><td><input type="text" value="'.$_SESSION['mc'].'"  name="mc"/></td></tr>
<tr><td class="q">固定电话：</td><td><input type="text" value="0'.$_SESSION['mf'].'"  name="mf"/></td></tr>
<tr><td class="q">提醒方式：</td><td q="'.$_SESSION['mq'].'" class="qq"  name="mq"></td></tr>
<tr><td class="q">邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;编：</td><td><input type="text" value="'.$_SESSION['mo'].'"  name="mo"/></td></tr>
</table>


<table cellspacing="0"  class="c">
<tr><th>商品编号</th><th colspan="2">商品名称</th><th>微购价</th><th>返现</th><th>赠送积分</th><th>数量</th><th>删除商品</th></tr>
<tr><td><input type="hidden" value="'.$pi.'" name="pi"/>'.$pi.'</td><td><a href=""><img src="http://localhost:8080/v-get.com/shop/imgs/1_2.jpg" /></a></td><td class="n"><input type="hidden" value="'.$pn.'" /><a href="">'.$pn.'</a></td><td><input type="hidden" value="'.$pp.'" /><span class="f2">￥'.$pp.'</span></td><td>'.$pb.'</td><td>'.$pj.'</td><td><input type="text" value="'.$pm.'" name="pm"/></td><td><a href="">删除</a></td>
</tr>
...
for(I=0;I<L(i);I++){
	...
	E(o,'dblclick',function(){this.readOnly=$0;this.style.borderColor='#cc0';});
	}
