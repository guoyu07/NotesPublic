...
<div class="l w-710 o-v">
	...
	<?php foreach((array)$data['list'] as $key=>$hotdoc) {?>
		<dl class="col-dl <?php if($indexcache['hotdocounts']==$key+1) { ?>bor_no<?php } ?>">
			<dt><a href="wiki/<?php echo rawurlencode($hotdoc['rawtitle']);?>"  title="<?php echo $hotdoc['title']?>"><?php echo $hotdoc['shorttitle']?></a></dt>
			<dd><?php echo $hotdoc['summary']?>[<a href="wiki/<?php echo rawurlencode($hotdoc['rawtitle']);?>"  class="entry">详细</a>]</dd>
		</dl>
	<?php }?>
</div></div>
	</div>
...
<?php if(isset($data['fistwonderdoc'])) { ?>
    <dl class="col-dl">
        <dd class="l"><a href="wiki/<?php echo rawurlencode($data['fistwonderdoc']['rawtitle']);?>"  class="a-img"><img title="<?php echo $data['fistwonderdoc']['title']?>" src="<?php echo $data['fistwonderdoc']['image']?>"/></a></dd>
        <dt class="h1 a-c bold"><a href="wiki/<?php echo rawurlencode($data['fistwonderdoc']['rawtitle']);?>" title="<?php echo $data['fistwonderdoc']['title']?>" ><?php echo $data['fistwonderdoc']['shorttitle']?></a></dt>
        <dd><p><?php echo $data['fistwonderdoc']['summary']?>...<a href="wiki/<?php echo rawurlencode($data['fistwonderdoc']['rawtitle']);?>" >阅读全文&gt;&gt;</a></p></dd>
    </dl>
    <ul class="col-ul point font-14 link_blue ">
        <?php foreach((array)$data['list'] as $wondoc) {?>
            <li><a href="wiki/<?php echo rawurlencode($wondoc['rawtitle']);?>" ><?php echo $wondoc['title']?></a>: <?php echo $wondoc['summary']?></li>
        <?php } ?>
    </ul>
<?php } ?>
</div></div>
...
<div id="zjgx" class="columns zjgx o-v <?php echo $data['config']['style']?>" bid="<?php echo $bid?>">
    ...
    <ul class="col-ul font-14 ">
       <?php foreach((array)$data['doclist'] as $doc) {?>
            <li><a href="wiki/<?php echo rawurlencode($doc['rawtitle']);?>"  class="ctm" title="<?php echo $doc['title']?>"><?php echo $doc['shorttitle']?></a><span><?php echo $doc['lastedit']?></span></li>
       <?php } ?>
    </ul>
...
<div id="zjpl" class="columns zjpl <?php echo $data['config']['style']?>" bid="<?php echo $bid?>">
	...
	<?php foreach((array)$data['list'] as $key=>$fistcomdoc) {?>
		<?php if($key<3) { ?>
		<div class="jc_tj">
			<a href="wiki/<?php echo rawurlencode($fistcomdoc['rawtitle']);?>"  class="a-img"><img alt="<?php echo $fistcomdoc['title']?>" title="<?php echo $fistcomdoc['title']?>" src="<?php echo $fistcomdoc['image']?>"/></a>
			<p class="a-c"><a href="wiki/<?php echo rawurlencode($fistcomdoc['rawtitle']);?>"  title="<?php echo $fistcomdoc['title']?>"><?php echo $fistcomdoc['shorttitle']?></a></p>
		</div>
		<?php } ?>
	<?php }?>
	</div>
	<ul class="col-ul point c-b">
		<?php foreach((array)$data['list'] as $key=>$commenddoc) {?>
			<?php if($key>=3) { ?>
			<li><a href="wiki/<?php echo rawurlencode($commenddoc['rawtitle']);?>"  title="<?php echo $commenddoc['title']?>"><?php echo $commenddoc['shorttitle']?></a></li>
			<?php } ?>
		<?php }?>
	</ul>
</div></div>
