...
';
	...
	if($_G['forum']['type'] == 'forum') {
		$navigation='<a href="http://e.v-get.com/i/">'.$_G['setting']['navs'][2]['navname']."</a> <em>&rsaquo;</em> <a href=\"http://e.v-get.com/i/topic-$_G[fid]-1.html\">".$_G['forum']['name']."</a> <em>&rsaquo;</em> <a href=\"http://e.v-get.com/i/tip-$_G[tid]-1.html\">$thread[subject]</a> ";
		$navtitle=strip_tags($_G['forum']['name']).' - '.$thread['subject'];
	} elseif($_G['forum']['type'] == 'sub') {
		$fup=C::t('forum_forum')->fetch($_G['forum']['fup']);
		$navigation='<a href="http://e.v-get.com/i/">'.$_G['setting']['navs'][2]['navname']."</a> <em>&rsaquo;</em> <a href=\"http://e.v-get.com/i/topic-$fup[fid]-1.html\">$fup[name]</a> &raquo; <a href=\"http://e.v-get.com/i/topic-$_G[fid]-1.html\">".$_G['forum']['name']."</a> <em>&rsaquo;</em> <a href=\"http://e.v-get.com/i/tip-$_G[tid]-1.html\">$thread[subject]</a> ";
