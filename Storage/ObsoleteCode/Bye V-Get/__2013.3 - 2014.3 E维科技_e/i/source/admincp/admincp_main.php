...
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"><link href="http://tu.v-get.com/i.ico" type="image/ico" rel="shortcut icon" /><title>E维科技管理中心</title>
...
<tr>
<td colspan="2" height="90"><div class="mainhd"><a href="http://e.v-get.com/i/" class="logo" target="_blank">E维科技管理中心</a><div class="uinfo" id="frameuinfo"><p>$header_welcome, $cpadmingroup <em>{$_G['member']['username']}</em> [<a href="$basescript?action=logout" target="_top">$header_logout</a>]</p><p class="btnlink"><a href="index.php" target="_blank">返回论坛</a></p></div>
<div class="navbg"></div>
<div class="nav">
<ul id="topmenu">
...
<div class="copyright"><p>Powered by <a href="http://e.v-get.com/i/">V-Get! Tech</a> </p><p>&copy; 2012-2013, <a href="http://www.v-get.com/">V-Get</a> .com</p></div>
