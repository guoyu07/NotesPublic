...
0
|| checktplrefresh('./template/default/forum/viewthread.htm', './template/default/forum/viewthread_node.htm', 1377587419, 'diy', './data/template/1_diy_forum_viewthread.tpl.php', './template/default', 'forum/viewthread')
|| checktplrefresh('./template/default/forum/viewthread.htm', './template/default/forum/viewthread_fastpost.htm', 1377587419, 'diy', './data/template/1_diy_forum_viewthread.tpl.php', './template/default', 'forum/viewthread')
|| checktplrefresh('./template/default/forum/viewthread.htm', './template/default/forum/viewthread_node_body.htm', 1377587419, 'diy', './data/template/1_diy_forum_viewthread.tpl.php', './template/default', 'forum/viewthread')
|| checktplrefresh('./template/default/forum/viewthread.htm', './template/default/common/seditor.htm', 1377587419, 'diy', './data/template/1_diy_forum_viewthread.tpl.php', './template/default', 'forum/viewthread')
|| checktplrefresh('./template/default/forum/viewthread.htm', './template/default/common/seccheck.htm', 1377587419, 'diy', './data/template/1_diy_forum_viewthread.tpl.php', './template/default', 'forum/viewthread')
|| checktplrefresh('./template/default/forum/viewthread.htm', './template/default/common/upload.htm', 1377587419, 'diy', './data/template/1_diy_forum_viewthread.tpl.php', './template/default', 'forum/viewthread')
...
<?php } ?>
<script src="<?php echo $_G['setting']['jspath'];?>forum_viewthread.js?<?php echo VERHASH;?>" type="text/javascript"></script><script type="text/javascript">zoomstatus=parseInt(<?php echo $_G['setting']['zoomstatus'];?>);var imagemaxwidth='<?php echo $_G['setting']['imagemaxwidth'];?>';var aimgcount=new Array();</script>
<style id="diy_style" type="text/css"></style>
<!--[diy=diynavtop]--><div id="diynavtop" class="area"></div><!--[/diy]-->
<div id="pt" class="bm cl"><div class="z"><a href="http://e.v-get.com/" class="nvhm" title="E维科技">E维科技</a><em>&raquo;</em><a href="http://e.v-get.com/i/">首页</a><?php echo $navigation;?> <em>&rsaquo;</em> <a href="http://e.v-get.com/i/tip-<?php echo $_G['tid'];?>-1.html"><?php echo $_G['forum_thread']['short_subject'];?></a></div></div>
...
<div id="ct" class="wp cl"><div id="pgt" class="pgs mbm cl <?php if($modmenu['thread']) { ?>pbm bbs<?php } ?>"><div class="pgt"><?php echo $multipage;?></div><span class="y pgb"<?php if($_G['setting']['visitedforums']) { ?> id="visitedforums" onmouseover="$('visitedforums').id='visitedforumstmp';this.id='visitedforums';showMenu({'ctrlid':this.id,'pos':'34'})"<?php } ?>><a href="<?php echo $upnavlink;?>">返回列表</a></span>
...
<?php } } else { if(!$_G['forum_thread']['is_archived']) { ?><a id="newspecial" href="http://e.v-get.com/i/forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>" title="发表帖子" target="_self"><img src="<?php echo IMGDIR;?>/pn_post.png" alt="发帖" /></a><?php } } ?>
...
<?php if(!$_G['forum']['allowspecialonly']) { ?><li><a href="http://e.v-get.com/i/forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>">发表帖子</a></li><?php } if($_G['forum']['threadsorts'] && !$_G['forum']['allowspecialonly']) { if(is_array($_G['forum']['threadsorts']['types'])) foreach($_G['forum']['threadsorts']['types'] as $id => $threadsorts) { if($_G['forum']['threadsorts']['show'][$id]) { ?>
<li class="popupmenu_option"><a href="http://e.v-get.com/i/forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>&sortid=<?php echo $id;?>"><?php echo $threadsorts;?></a></li>
<?php } } } if($_G['group']['allowpostpoll']) { ?><li class="poll"><a href="http://e.v-get.com/i/forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>&special=1">发起投票</a></li><?php } if($_G['group']['allowpostreward']) { ?><li class="reward"><a href="http://e.v-get.com/i/forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>&special=3">发布悬赏</a></li><?php } if($_G['group']['allowpostdebate']) { ?><li class="debate"><a href="http://e.v-get.com/i/forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>&special=5">发起辩论</a></li><?php } if($_G['group']['allowpostactivity']) { ?><li class="activity"><a href="http://e.v-get.com/i/forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>&special=4">发起活动</a></li><?php } if($_G['group']['allowposttrade']) { ?><li class="trade"><a href="http://e.v-get.com/i/forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>&special=2">出售商品</a></li><?php } if($_G['setting']['threadplugins']) { if(is_array($_G['forum']['threadplugin'])) foreach($_G['forum']['threadplugin'] as $tpid) { if(array_key_exists($tpid, $_G['setting']['threadplugins']) && @in_array($tpid, $_G['group']['allowthreadplugin'])) { ?>
<li class="popupmenu_option"<?php if($_G['setting']['threadplugins'][$tpid]['icon']) { ?> style="background-image:url(source/plugin/<?php echo $tpid;?>/<?php echo $_G['setting']['threadplugins'][$tpid]['icon'];?>)"<?php } ?>><a href="http://e.v-get.com/i/forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>&specialextra=<?php echo $tpid;?>"><?php echo $_G['setting']['threadplugins'][$tpid]['name'];?></a></li>
<?php } } } ?>
</ul>
<?php } if($modmenu['post']) { ?>
...
<?php } ?><td class="plc ptm pbn vwthd">
<?php if(!IS_ROBOT) { ?>
<div class="y">
<?php if($post['invisible'] == 0) { ?><a href="http://e.v-get.com/i/tip-<?php echo $_G['tid'];?>-1.html?action=printable" title="打印本页" target="_blank"><img src="<?php echo IMGDIR;?>/print.png" alt="打印" class="vm" /></a>
<?php } ?>
<a href="http://e.v-get.com/i/forum.php?mod=redirect&goto=nextoldset&tid=<?php echo $_G['tid'];?>" title="上一主题"><img src="<?php echo IMGDIR;?>/thread-prev.png" alt="上一主题" class="vm" /></a>
<a href="http://e.v-get.com/i/forum.php?mod=redirect&goto=nextnewset&tid=<?php echo $_G['tid'];?>" title="下一主题"><img src="<?php echo IMGDIR;?>/thread-next.png" alt="下一主题" class="vm" /></a>
</div>
...
<a href="http://e.v-get.com/i/forum.php?mod=forumdisplay&fid=<?php echo $_G['fid'];?>&filter=typeid&typeid=<?php echo $_G['forum_thread']['typeid'];?>">[<?php echo $_G['forum']['threadtypes']['types'][$_G['forum_thread']['typeid']];?>]</a>
<?php } else { ?>
[<?php echo $_G['forum']['threadtypes']['types'][$_G['forum_thread']['typeid']];?>]
<?php } } if($threadsorts && $_G['forum_thread']['sortid']) { ?>
<a href="http://e.v-get.com/i/forum.php?mod=forumdisplay&fid=<?php echo $_G['fid'];?>&filter=sortid&sortid=<?php echo $_G['forum_thread']['sortid'];?>">[<?php echo $_G['forum']['threadsorts']['types'][$_G['forum_thread']['sortid']];?>]</a>
<?php } ?>
...
<a class="psave" href="http://e.v-get.com/i/forum.php?mod=misc&action=pubsave&tid=<?php echo $_G['tid'];?>">发表</a>
...
<?php } ?>
<a href="http://e.v-get.com/i/tip-<?php echo $_G['tid'];?>-1.html<?php if($_G['member']['username']) { ?>?fromuser=<?php echo $_G['member']['username'];?><?php } ?>" onclick="return copyThreadUrl(this)">[推广奖励]</a></span>
...
<a href="http://e.v-get.com/i/tip-<?php echo $post['tid'];?>-1.html?checkrush=1" rel="nofollow" class="y pn xi2"><span>查看抢中楼层</span></a>
<?php } ?>
</span>
...
<a href="http://e.v-get.com/i/tip-<?php echo $_G['tid'];?>-1.html" class="xi2">返回抢楼帖</a>
</p>
<?php } ?>
</td>
</tr>
...
$authorverifys .= <<<EOF
<a href="http://e.v-get.com/i/home.php?mod=spacecp&ac=profile&op=verify&vid={$vid}" target="_blank">
EOF;
...
$authorverifys .= <<<EOF
<a href="http://e.v-get.com/i/home.php?mod=spacecp&ac=profile&op=verify&vid={$vid}" target="_blank"><img src="{$_G['setting']['verify'][$vid]['unverifyicon']}" class="vm" alt="{$_G['setting']['verify'][$vid]['title']}" title="{$_G['setting']['verify'][$vid]['title']}" /></a>
...
<div class="pi">
<div class="authi"><a href="http://e.v-get.com/i/<?php echo $post['author'];?>" target="_blank" class="xw1"<?php if($post['groupcolor']) { ?> style="color: <?php echo $post['groupcolor'];?>"<?php } ?>><?php echo $post['author'];?></a><?php echo $authorverifys;?></div>
</div>
<?php } ?>
...
<div class="i y">
<div>
<strong><a href="http://e.v-get.com/i/<?php echo $post['author'];?>" target="_blank" class="xi2"<?php if($post['groupcolor']) { ?> style="color: <?php echo $post['groupcolor'];?>"<?php } ?>><?php echo $post['author'];?></a></strong>
...
<em>当前离线</em>
<?php } } ?>
</div><?php viewthread_profile_node('top', $post);?><div id="avatarfeed"><span id="threadsortswait"></span></div>
</div>
</div>
...
<a href="http://e.v-get.com/i/misc.php?mod=mobile" tip="该帖通过手机客户端发布" onmouseover="showTip(this)"></a>
</div>
<?php } ?>
<div class="avatar"<?php if(!($_G['setting']['threadguestlite'] && !$_G['uid'])) { ?> onmouseover="showauthor(this, 'userinfo<?php echo $post['pid'];?>')"<?php } ?>><a href="http://e.v-get.com/i/<?php echo $post['author'];?>" class="avtm" target="_blank"><?php echo $post['avatar'];?></a></div>
<?php } ?>
...
<li class="addflw">
<a href="http://e.v-get.com/i/home.php?mod=spacecp&ac=follow&op=add&hash=<?php echo FORMHASH;?>&fuid=<?php echo $post['authorid'];?>" id="followmod_<?php echo $post['authorid'];?>" title="收听TA" class="xi2" onclick="showWindow('followmod', this.href, 'get', 0);">收听TA</a>
</li>
<?php } ?>
<li class="pm2"><a href="http://e.v-get.com/i/home.php?mod=spacecp&ac=pm&op=showmsg&handlekey=showmsg_<?php echo $post['authorid'];?>&touid=<?php echo $post['authorid'];?>&pmid=0&daterange=2&pid=<?php echo $post['pid'];?>&tid=<?php echo $post['tid'];?>" onclick="showWindow('sendpm', this.href);" title="发消息" class="xi2">发消息</a></li>
</ul>
<?php } } ?>
...
<div class="pi"><div class="authi"><a href="http://e.v-get.com/i/<?php echo $post['author'];?>" class="xw1"><?php echo $post['author'];?></a></div></div>
<?php } if($showavatars) { ?>
<div><div class="avatar avtm"><a href="javascript:;"><?php echo $post['avatar'];?></a></div></div>
<?php } } else { ?>
<div class="pi">
<?php if(!$post['authorid']) { ?>
<a href="javascript:;"><?php echo $_G['setting']['anonymoustext'];?> <em><?php echo $post['useip'];?></em></a>
<?php } elseif($post['authorid'] && $post['username'] && $post['anonymous']) { if($_G['forum']['ismoderator']) { ?><a href="http://e.v-get.com/i/<?php echo $post['author'];?>" target="_blank"><?php echo $_G['setting']['anonymoustext'];?></a><?php } else { ?><?php echo $_G['setting']['anonymoustext'];?><?php } } else { ?>
...
<a href="http://e.v-get.com/i/forum.php?mod=topicadmin&action=getip&fid=<?php echo $_G['fid'];?>&tid=<?php echo $_G['tid'];?>&pid=<?php echo $post['pid'];?><?php if($_G['forum_auditstatuson']) { ?>&modthreadkey=<?php echo $_GET['modthreadkey'];?><?php } ?>" onclick="ajaxmenu(this, 0, 0, 2);doane(event)">IP</a>
<?php } if($_G['group']['allowedituser']) { ?>
<a href="<?php if($_G['adminid'] == 1) { ?>http://e.v-get.com/i/admin.php?frames=yes&action=members&operation=search&uid=<?php echo $post['authorid'];?>&submit=yes<?php } else { ?>http://e.v-get.com/i/forum.php?mod=modcp&action=member&op=edit&uid=<?php echo $post['authorid'];?><?php } ?>" target="_blank">编辑</a>
<?php } if($_G['group']['allowbanuser']) { if($_G['adminid'] == 1) { ?>
<a href="http://e.v-get.com/i/admin.php?action=members&operation=ban&username=<?php echo $post['usernameenc'];?>&frames=yes" target="_blank">禁言</a>
<?php } else { ?>
<a href="http://e.v-get.com/i/forum.php?mod=modcp&action=member&op=ban&uid=<?php echo $post['authorid'];?>" target="_blank">禁言</a>
<?php } } ?>
<a href="http://e.v-get.com/i/forum.php?mod=modcp&action=thread&op=post&do=search&searchsubmit=1&users=<?php echo $post['usernameenc'];?>" target="_blank">帖子</a>
<?php if($_G['adminid'] == 1) { ?>
<a href="http://e.v-get.com/i/forum.php?mod=ajax&action=quickclear&uid=<?php echo $post['authorid'];?>" onclick="showWindow('qclear_<?php echo $post['authorid'];?>', this.href, 'get', 0)">清理</a>
<?php } ?>
</p>
<?php } ?>
</div>
...
<?php } if($post['warned']) { ?>
<a href="http://e.v-get.com/i/forum.php?mod=misc&action=viewwarning&tid=<?php echo $_G['tid'];?>&uid=<?php echo $post['authorid'];?>" title="受到警告" class="y" onclick="showWindow('viewwarning', this.href)"><img src="<?php echo IMGDIR;?>/warning.gif" alt="受到警告" /></a>
<?php } ?>
<strong>
<a href="http://e.v-get.com/i/<?php echo $post['author'];?>">
...
<a href="http://e.v-get.com/i/tip-<?php echo $post['tid'];?>-1.html" title="查看抢中楼层" class="v">恭喜</a>
<a href="http://e.v-get.com/i/tip-<?php echo $post['tid'];?>-1.html?checkrush=1" title="查看抢中楼层" class="b">抢中本楼</a>
</label>
<?php } if(!$post['first'] && $_G['forum_thread']['special'] == 5) { ?>
<label class="pdbts pdbts_<?php echo intval($post['stand']); ?>">
<?php if($post['stand'] == 1) { ?><a class="v" href="http://e.v-get.com/i/tip-<?php echo $_G['tid'];?>-1.html?extra=<?php echo $_GET['extra'];?>&filter=debate&stand=1" title="只看正方">正方</a>
<?php } elseif($post['stand'] == 2) { ?><a class="v" href="http://e.v-get.com/i/tip-<?php echo $_G['tid'];?>-1.html?extra=<?php echo $_GET['extra'];?>&filter=debate&stand=2" title="只看反方">反方</a>
<?php } else { ?><a href="http://e.v-get.com/i/tip-<?php echo $_G['tid'];?>-1.html?extra=<?php echo $_GET['extra'];?>&filter=debate&stand=0" title="只看中立">中立</a><?php } if($post['stand']) { ?>
...
<a href="http://e.v-get.com/i/<?php echo $post['author'];?>" target="_blank" class="xi2 z" style="padding-right:10px;"><?php echo avatar($post['authorid'], 'small'); ?></a>
...
<?php } if(!$_G['setting']['authoronleft']) { ?><a href="http://e.v-get.com/i/<?php echo $post['author'];?>" target="_blank" class="xi2"><?php echo $post['author'];?></a><?php echo $authorverifys;?><?php } if($close_leftinfo) { } ?>
...
<a href="http://e.v-get.com/i/tip-<?php echo $post['tid'];?>-<?php echo $page;?>?authorid=<?php echo $post['authorid'];?>" rel="nofollow">只看该作者</a>
<?php } elseif(!$_G['forum_thread']['archiveid']) { ?>
<a href="http://e.v-get.com/i/tip-<?php echo $post['tid'];?>-<?php echo $page;?>.html">显示全部楼层</a>
...
<span class="pipe">|</span><a href="http://e.v-get.com/i/tip-<?php echo $_G['tid'];?>-1.html?from=album">只看大图</a>
<?php } ?>
<span class="none"><img src="<?php echo IMGDIR;?>/arw_r.gif" class="vm" alt="回帖奖励" /></span>
<?php if(!$rushreply) { if($ordertype != 1) { ?>
<span class="pipe show">|</span><a href="http://e.v-get.com/i/tip-<?php echo $_G['tid'];?>-1.html?extra=<?php echo $_GET['extra'];?>&ordertype=1"  class="show">倒序浏览</a>
<?php } else { ?>
<span class="pipe show">|</span><a href="http://e.v-get.com/i/tip-<?php echo $_G['tid'];?>-1.html?extra=<?php echo $_GET['extra'];?>&ordertype=2"  class="show">正序浏览</a>
<?php } } } if($post['first']) { ?>
...
<div class="locked"><em class="y"><a href="http://e.v-get.com/i/forum.php?mod=misc&action=viewpayments&tid=<?php echo $_G['tid'];?>" onclick="showWindow('pay', this.href)">记录</a></em>付费主题, 价格: <strong><?php echo $_G['forum_thread']['price'];?> <?php echo $_G['setting']['extcredits'][$_G['setting']['creditstransextra']['1']]['unit'];?><?php echo $_G['setting']['extcredits'][$_G['setting']['creditstransextra']['1']]['title'];?> </strong></div>
...
<div class="psta vm">
<a href="http://e.v-get.com/i/<?php echo $comment['author'];?>" c="1"><?php echo $comment['avatar'];?></a>
<?php if($comment['authorid']) { ?>
<a href="http://e.v-get.com/i/<?php echo $comment['author'];?>" class="xi2 xw1"><?php echo $comment['author'];?></a>
<?php } else { ?>
游客
<?php } ?>
</div>
...
<?php if($comment['rpid']) { ?>
<a href="http://e.v-get.com/i/forum.php?mod=redirect&goto=findpost&pid=<?php echo $comment['rpid'];?>&ptid=<?php echo $_G['tid'];?>" class="xi2">详情</a>
<a href="http://e.v-get.com/i/forum.php?mod=post&action=reply&fid=<?php echo $_G['fid'];?>&tid=<?php echo $_G['tid'];?>&repquote=<?php echo $comment['rpid'];?>&extra=<?php echo $_GET['extra'];?>&page=<?php echo $page;?><?php if($_GET['from']) { ?>&from=<?php echo $_GET['from'];?><?php } ?>" class="xi2" onclick="showWindow('reply', this.href)">回复</a>
<?php } ?>
<span class="xg1">
...
<strong><a href="http://e.v-get.com/i/forum.php?mod=misc&action=viewratings&tid=<?php echo $_G['tid'];?>&pid=<?php echo $post['pid'];?>" onclick="showWindow('viewratings', this.href)" title="已有<?php echo count($postlist[$post['pid']]['totalrate']);; ?>人评分, 查看全部评分"><?php echo count($postlist[$post['pid']]['totalrate']);; ?></a></strong>
<p><a href="http://e.v-get.com/i/forum.php?mod=misc&action=viewratings&tid=<?php echo $_G['tid'];?>&pid=<?php echo $post['pid'];?>" onclick="showWindow('viewratings', this.href)">查看全部评分</a></p>
<?php } ?>
</dt>
<dd>
<?php } ?>
...
<table class="ratl">
<tr>
<th class="xw1" width="120"><a href="http://e.v-get.com/i/forum.php?mod=misc&action=viewratings&tid=<?php echo $_G['tid'];?>&pid=<?php echo $post['pid'];?>" onclick="showWindow('viewratings', this.href)" title="查看全部评分"> 参与人数 <span class="xi1"><?php echo count($postlist[$post['pid']]['totalrate']);; ?></span></a></th><?php if(is_array($post['ratelogextcredits'])) foreach($post['ratelogextcredits'] as $id => $score) { if($score > 0) { ?>
...
<td>
<a href="http://e.v-get.com/i/<?php echo $ratelog['username'];?>" target="_blank"><?php echo avatar($uid, 'small');; ?></a> <a href="http://e.v-get.com/i/<?php echo $ratelog['username'];?>" target="_blank"><?php echo $ratelog['username'];?></a>
...
<p class="ratc">
<a href="http://e.v-get.com/i/forum.php?mod=misc&action=viewratings&tid=<?php echo $_G['tid'];?>&pid=<?php echo $post['pid'];?>" onclick="showWindow('viewratings', this.href)" title="查看全部评分" class="xi2">查看全部评分</a>
</p>
<?php } else { ?>
...
<?php } } ?>" class="mtn mbn"><a href="http://e.v-get.com/i/<?php echo $ratelog['username'];?>" target="_blank" class="avt"><?php echo avatar($uid, 'small');; ?></a></p>
<p><a href="http://e.v-get.com/i/<?php echo $ratelog['username'];?>" target="_blank"><?php echo $ratelog['username'];?></a></p>
</li>
<?php } ?>
</ul>
<?php } ?>
...
<ul class="mbw xl xl2 cl"><?php if(is_array($post['relatecollection'])) foreach($post['relatecollection'] as $var) { ?><li>&middot; <a href="http://e.v-get.com/i/forum.php?mod=collection&action=view&ctid=<?php echo $var['ctid'];?>" title="<?php echo $var['name'];?>" target="_blank" class="xi2 xw1"><?php echo $var['name'];?></a><span class="pipe">|</span><span class="xg1">主题: <?php echo $var['threadnum'];?>, 订阅: <?php echo $var['follownum'];?></span></li>
<?php } if($post['releatcollectionmore']) { ?>
<li>&middot; <a href="http://e.v-get.com/i/forum.php?mod=collection&tid=<?php echo $_G['tid'];?>" target="_blank" class="xi2 xw1">更多</a></li>
<?php } ?>
</ul>
</div>
...
<a class="followp" href="http://e.v-get.com/i/home.php?mod=spacecp&ac=follow&op=relay&tid=<?php echo $_G['tid'];?>&from=forum" onclick="showWindow('relaythread', this.href, 'get', 0);" title="转播求扩散"><i><img src="<?php echo IMGDIR;?>/rt.png" alt="转播" />转播<?php if($_G['forum_thread']['relay']) { ?><span id="relaynumber" style="display:none"><?php echo $_G['forum_thread']['relay'];?></span><?php } ?></i></a>
<?php } if($post['first'] && helper_access::check_module('share')) { ?>
<a class="sharep" href="http://e.v-get.com/i/home.php?mod=spacecp&ac=share&type=thread&id=<?php echo $_G['tid'];?>" onclick="showWindow('sharethread', this.href, 'get', 0);" title="分享推精华"><i><img src="<?php echo IMGDIR;?>/oshr.png" alt="分享" />分享<?php if($_G['forum_thread']['sharetimes']) { ?><span id="sharenumber"><?php echo $_G['forum_thread']['sharetimes'];?></span><?php } ?></i></a>
<?php } if(!$_G['forum']['disablecollect'] && helper_access::check_module('collection')) { ?>
<a href="http://e.v-get.com/i/forum.php?mod=collection&action=edit&op=addthread&tid=<?php echo $_G['tid'];?>" id="k_collect" onclick="showWindow(this.id, this.href);return false;" onmouseover="this.title = $('collectionnumber').innerHTML + ' 人淘帖'" title="淘好帖进专辑"><i><img src="<?php echo IMGDIR;?>/collection.png" alt="分享" />淘帖<span id="collectionnumber"<?php if(!$post['releatcollectionnum']) { ?> style="display:none"<?php } ?>><?php echo $post['releatcollectionnum'];?></span></i></a>
...
<ul class="xl xl2 cl"><?php if(is_array($post['relateitem'])) foreach($post['relateitem'] as $var) { ?><li>&#8226; <a href="http://e.v-get.com/i/tip-<?php echo $var['tid'];?>-1.html" title="<?php echo $var['subject'];?>" target="_blank"><?php echo $var['subject'];?></a></li>
<?php } ?>
</ul>
</div>
<?php } ?>
...
<a href="http://e.v-get.com/i/home.php?mod=spacecp&ac=favorite&type=thread&id=<?php echo $_G['tid'];?>" id="k_favorite" onclick="showWindow(this.id,this.href,'get',0);" onmouseover="this.title=$('favoritenumber').innerHTML+'人收藏'" title="收藏本帖">收藏<span id="favoritenumber"<?php if(!$_G['forum_thread']['favtimes']) { ?> style="display:none"<?php } ?>><?php echo $_G['forum_thread']['favtimes'];?></span></a>
</em>
...
<a href="http://e.v-get.com/i/forum.php?mod=misc&action=removerate&tid=<?php echo $_G['tid'];?>&pid=<?php echo $post['pid'];?>&page=<?php echo $page;?>" onclick="showWindow('rate', this.href, 'get', -1)">撤销评分</a>
...
<li><a href="http://e.v-get.com/i/home.php?mod=magic&mid=bump&idtype=tid&id=<?php echo $_G['tid'];?>" id="a_bump" onclick="showWindow(this.id, this.href)"><img src="<?php echo STATICURL;?>image/magic/bump.small.gif" /><?php echo $_G['setting']['magics']['bump'];?></a></li>
<?php } if(!empty($_G['setting']['magics']['stick'])) { ?>
<li><a href="http://e.v-get.com/i/home.php?mod=magic&mid=stick&idtype=tid&id=<?php echo $_G['tid'];?>" id="a_stick" onclick="showWindow(this.id, this.href)"><img src="<?php echo STATICURL;?>image/magic/stick.small.gif" /><?php echo $_G['setting']['magics']['stick'];?></a></li>
<?php } if(!empty($_G['setting']['magics']['close'])) { ?>
<li><a href="http://e.v-get.com/i/home.php?mod=magic&mid=close&idtype=tid&id=<?php echo $_G['tid'];?>" id="a_stick" onclick="showWindow(this.id, this.href)"><img src="<?php echo STATICURL;?>image/magic/close.small.gif" /><?php echo $_G['setting']['magics']['close'];?></a></li>
<?php } if(!empty($_G['setting']['magics']['open'])) { ?>
<li><a href="http://e.v-get.com/i/home.php?mod=magic&mid=open&idtype=tid&id=<?php echo $_G['tid'];?>" id="a_stick" onclick="showWindow(this.id, this.href)"><img src="<?php echo STATICURL;?>image/magic/open.small.gif" /><?php echo $_G['setting']['magics']['open'];?></a></li>
<?php } if(!empty($_G['setting']['magics']['highlight'])) { ?>
<li><a href="http://e.v-get.com/i/home.php?mod=magic&mid=highlight&idtype=tid&id=<?php echo $_G['tid'];?>" id="a_stick" onclick="showWindow(this.id, this.href)"><img src="<?php echo STATICURL;?>image/magic/highlight.small.gif" /><?php echo $_G['setting']['magics']['highlight'];?></a></li>
<?php } if(!empty($_G['setting']['magics']['sofa'])) { ?>
<li><a href="http://e.v-get.com/i/home.php?mod=magic&mid=sofa&idtype=tid&id=<?php echo $_G['tid'];?>" id="a_stick" onclick="showWindow(this.id, this.href)"><img src="<?php echo STATICURL;?>image/magic/sofa.small.gif" /><?php echo $_G['setting']['magics']['sofa'];?></a></li>
<?php } if(!empty($_G['setting']['magics']['jack'])) { ?>
<li><a href="http://e.v-get.com/i/home.php?mod=magic&mid=jack&idtype=tid&id=<?php echo $_G['tid'];?>" id="a_jack" onclick="showWindow(this.id, this.href)"><img src="<?php echo STATICURL;?>image/magic/jack.small.gif" /><?php echo $_G['setting']['magics']['jack'];?></a></li>
<?php } ?>
...
<li><a href="http://e.v-get.com/i/home.php?mod=magic&mid=repent&idtype=pid&id=<?php echo $post['pid'];?>:<?php echo $_G['tid'];?>" id="a_repent_<?php echo $post['pid'];?>" onclick="showWindow(this.id, this.href)"><img src="<?php echo STATICURL;?>image/magic/repent.small.gif" /><?php echo $_G['setting']['magics']['repent'];?></a></li>
<?php } if(!empty($_G['setting']['magics']['anonymouspost']) && $post['authorid'] == $_G['uid']) { ?>
<li><a href="http://e.v-get.com/i/home.php?mod=magic&mid=anonymouspost&idtype=pid&id=<?php echo $post['pid'];?>:<?php echo $_G['tid'];?>" id="a_anonymouspost_<?php echo $post['pid'];?>" onclick="showWindow(this.id, this.href)"><img src="<?php echo STATICURL;?>image/magic/anonymouspost.small.gif" /><?php echo $_G['setting']['magics']['anonymouspost'];?></a><li>
<?php } if(!empty($_G['setting']['magics']['namepost'])) { ?>
<li><a href="http://e.v-get.com/i/home.php?mod=magic&mid=namepost&idtype=pid&id=<?php echo $post['pid'];?>:<?php echo $_G['tid'];?>" id="a_namepost_<?php echo $post['pid'];?>" onclick="showWindow(this.id, this.href)"><img src="<?php echo STATICURL;?>image/magic/namepost.small.gif" /><?php echo $_G['setting']['magics']['namepost'];?></a><li>
<?php } ?>
...
<li<?php if(!isset($_GET['stand'])) { ?> class="xw1 a"<?php } ?>><a href="http://e.v-get.com/i/tip-<?php echo $_G['tid'];?>-1.html?extra=<?php echo $_GET['extra'];?>" hidefocus="true">全部</a></li>
<li<?php if($_GET['stand'] == 1) { ?> class="xw1 a"<?php } ?>><a href="http://e.v-get.com/i/tip-<?php echo $_G['tid'];?>-1.htmlextra=<?php echo $_GET['extra'];?>&stand=1" hidefocus="true">正方</a></li>
<li<?php if($_GET['stand'] == 2) { ?> class="xw1 a"<?php } ?>><a href="http://e.v-get.com/i/tip-<?php echo $_G['tid'];?>-1.html?&extra=<?php echo $_GET['extra'];?>&stand=2" hidefocus="true">反方</a></li>
<li<?php if(isset($_GET['stand']) && $_GET['stand'] == 0) { ?> class="xw1 a"<?php } ?>><a href="http://e.v-get.com/i/tip-<?php echo $_G['tid'];?>-1.html?extra=<?php echo $_GET['extra'];?>&stand=0" hidefocus="true">中立</a></li>
</ul>
...
<?php } ?><form method="post" autocomplete="off" name="modactions" id="modactions"><input type="hidden" name="formhash" value="<?php echo FORMHASH;?>" /><input type="hidden" name="optgroup" /><input type="hidden" name="operation" /><input type="hidden" name="listextra" value="<?php echo $_GET['extra'];?>" /><input type="hidden" name="page" value="<?php echo $page;?>" /></form>
<?php echo $_G['forum_tagscript'];?>
<?php if($multipage && $page < $_G['setting']['threadmaxpages'] && $page < $_G['page_next']) { $nxtpage=$page + 1;?><div class="pgbtn"><a href="http://e.v-get.com/i/tip-<?php echo $_G['tid'];?>-<?php echo $nxtpage;?>.html<?php if($_GET['authorid']) { ?>?authorid=<?php echo $_GET['authorid'];?><?php } ?>" hidefocus="true" class="bm_h">下一页 &raquo;</a></div><?php } ?>
...
<p class="ptm pnpost">
<a href="http://e.v-get.com/i/home.php?mod=spacecp&ac=credit&op=rule&fid=<?php echo $_G['fid'];?>" class="y" target="_blank">本版积分规则</a>
...
<table cellspacing="0" cellpadding="0">
<tr>
<td id="v_forums"><h3 class="mbn pbn bbda xg1">浏览过的版块</h3><ul class="xl xl1"><?php echo $_G['setting']['visitedforums'];?></ul></td></tr></table>
</div>
...
<?php } } if(!IS_ROBOT && !empty($_G['setting']['lazyload'])) { ?><script type="text/javascript">new lazyload();</script><?php } if(!IS_ROBOT && $_G['setting']['threadmaxpages'] > 1) { ?>
<script type="text/javascript">document.onkeyup=function(e){keyPageScroll(e, <?php if($page > 1) { ?>1<?php } else { ?>0<?php } ?>, <?php if($page < $_G['setting']['threadmaxpages'] && $page < $_G['page_next']) { ?>1<?php } else { ?>0<?php } ?>, 'http://e.v-get.com/i/tip-<?php echo $_G['tid'];?>-1.html<?php if($_GET['authorid']) { ?>&authorid=<?php echo $_GET['authorid'];?><?php } ?>', <?php echo $page;?>);}</script>
<?php } ?>
</div>
...
menudiv.innerHTML='<div class="tip_c xs0"><a onclick="showWindow(\'setcover_'+newimgid+'\', this.href)" href="http://e.v-get.com/i/forum.php?mod=ajax&amp;action=setthreadcover&amp;tid=<?php echo $_G['tid'];?>&amp;pid=<?php echo $_G['forum_firstpid'];?>&amp;fid=<?php echo $_G['fid'];?>&imgurl='+imgsrc+'">设为封面</a></div>';
obj.id=newimgid;
...
if(values['type'] == 'add') {
fObj.innerHTML='不收听';fObj.href='http://e.v-get.com/i/home.php?mod=spacecp&ac=follow&op=del&fuid='+values['fuid'];
} else if(values['type'] == 'del') {fObj.innerHTML='收听TA';
fObj.href='http://e.v-get.com/i/home.php?mod=spacecp&ac=follow&op=add&hash=<?php echo FORMHASH;?>&fuid='+values['fuid'];
}
}
<?php if($_G['blockedpids']) { ?>
...
fixed_top_nv();
<?php } ?></script><?php include template('common/footer'); ?>