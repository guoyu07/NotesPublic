...
<p class="xs0">E维科技，专注网络营销</p></div>
<div id="frt"><p>Powered by <strong><a href="http://e.v-get.com/i/" target="_blank">Discuz!</a></strong> <em>Tech</em></p><p class="xs0">&copy; 2012-2013 <a href="http://www.v-get.com/" target="_blank">V-Get.com</a></p></div><?php updatesession();?><?php if($_G['uid'] && $_G['group']['allowinvisible']) { ?>
<script type="text/javascript">
