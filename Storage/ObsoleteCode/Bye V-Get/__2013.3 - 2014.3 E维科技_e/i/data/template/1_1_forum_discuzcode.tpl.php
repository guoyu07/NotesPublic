...
<a href="http://e.v-get.com/i/forum.php?mod=attachment{$is_archive}&aid={$aidencode}" 
EOF;
...
<a href="http://e.v-get.com/i/forum.php?mod=misc&action=attachpay&aid={$attach['aid']}&tid={$attach['tid']}" onclick="showWindow('attachpay', this.href)">{$attach['filename']}</a>
...
售价: <strong>{$attach['price']} {$_G['setting']['extcredits'][$_G['setting']['creditstransextra']['1']]['unit']}{$_G['setting']['extcredits'][$_G['setting']['creditstransextra']['1']]['title']}</strong> &nbsp;[<a href="http://e.v-get.com/i/forum.php?mod=misc&action=viewattachpayments&aid={$attach['aid']}" onclick="showWindow('attachpay', this.href)" target="_blank">记录</a>]

EOF;
 if(!$attach['payed']) { 
$return .= <<<EOF

&nbsp;[<a href="http://e.v-get.com/i/forum.php?mod=misc&action=attachpay&aid={$attach['aid']}&tid={$attach['tid']}" onclick="showWindow('attachpay', this.href)">购买</a>]
...
<p class="mbn">
<a href="http://e.v-get.com/i/forum.php?mod=attachment{$is_archive}&aid={$aidencode}&nothumb=yes" 
EOF;
 if($_GET['from'] != 'preview') { 
$return .= <<<EOF
...
<div>
<p>
<a href="http://e.v-get.com/i/forum.php?mod=attachment{$is_archive}&aid={$aidencode}&nothumb=yes" target="_blank">下载附件</a>
...
&nbsp;<a href="http://e.v-get.com/i/forum.php?mod=ajax&action=setthreadcover&aid={$attach['aid']}&fid={$_G['fid']}" onclick="showWindow('setcover{$attach['aid']}', this.href)">设为封面</a>
...
&nbsp;[<a href="http://e.v-get.com/i/forum.php?mod=misc&action=attachpay&aid={$attach['aid']}&tid={$attach['tid']}" onclick="showWindow('attachpay', this.href)" target="_blank">购买</a>]
...
<img id="aimg_{$attach['aid']}" class="guestviewthumb_cur" aid="{$attach['aid']}" src="{$__STATICURL}image/common/none.gif" onclick="showWindow('login', 'http://e.v-get.com/i/member.php?mod=logging&action=login'+'&referer='+encodeURIComponent(location))" onerror="javascript:if(this.getAttribute('makefile')){this.src=this.getAttribute('makefile'); this.removeAttribute('makefile');}" file="{$thumbpath}" makefile="{$makefile}" alt="{$attach['imgalt']}" title="{$attach['imgalt']}"/>
<br>
<a href="http://e.v-get.com/i/member.php?mod=logging&action=login" onclick="showWindow('login', this.href+'&referer='+encodeURIComponent(location));">登录/注册后可看大图</a>
</div>
...
&nbsp;<a href="javascript:;" onclick="showWindow(this.id, this.getAttribute('url'), 'get', 0);" id="savephoto_{$attach['aid']}" url="http://e.v-get.com/i/home.php?mod=spacecp&amp;ac=album&amp;op=saveforumphoto&amp;aid={$attach['aid']}&amp;handlekey=savephoto_{$attach['aid']}">保存到相册</a>
...
<a href="http://e.v-get.com/i/forum.php?mod=attachment{$is_archive}&aid={$aidencode}" target="_blank">{$attach['filename']}</a>
...
<br />售价: {$attach['price']} {$_G['setting']['extcredits'][$_G['setting']['creditstransextra']['1']]['unit']}{$_G['setting']['extcredits'][$_G['setting']['creditstransextra']['1']]['title']}	&nbsp;<a href="http://e.v-get.com/i/forum.php?mod=misc&action=viewattachpayments&aid={$attach['aid']}" onclick="showWindow('attachpay', this.href)" target="_blank">[记录]</a>
