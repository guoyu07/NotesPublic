...
$Qq=mysql_query(\'SELECT i,t,h,g,d FROM f2013 WHERE g=\'.$G.\' ORDER BY i DESC LIMIT \'.$Qp.\','.constant('TECH_I_page_article').'\',$QC);
$Qy=mysql_query(\'SELECT COUNT(*) FROM f2013 WHERE g=\'.$G);
$Qz=mysql_fetch_array($Qy);
$Qt=$Qz[0];$Pz=ceil($Qt/'.constant('TECH_I_page_article').');
?>';
$text.=constant('CSSJS').'<link rel="stylesheet" type="text/css" href="'.constant('LTU').'f.css" /><link rel="stylesheet" type="text/css" href="'.constant('LTU_8').'tech/f.css" /><?php echo \'<title>热门推荐_E维站长之家_V-Get!</title><meta name="keywords" content="SEO,站长之家,网络营销,PHP教程,网络创业"/>\';?>';
...
<a href="'.constant('LK').'">首页</a>&nbsp;&gt;&gt;&nbsp;<a href="'.constant('LK').'tech/">站长之家</a>&nbsp;&gt;&gt;&nbsp;<a href="'.constant('LK').'tech/top\',$G,\'_1.html">热门推荐</a><span></span></div>\';
while($Qa=mysql_fetch_array($Qq)){
$T=$Qa[\'t\'];$t=strtotime($T);$t=date(\'Ymd/His\',$t);
echo \'<h2><a href="'.constant('LK').'tech/top\',$G,\'_1.html" class="fg\',$G,\'"></a><a href="'.constant('LK').'tech/\',$t,$Qa[\'i\'],\'.html">\',$Qa[\'h\'],\'</a><i>\',$T,\'</i></h2><p>\',$Qa[\'d\'],\'</p>\';

}

'.$c_mysql_page->show('sp1',constant('LK').'tech/top_[$G]_1.html',constant('LK').'tech/top_[$G]_{_}.html','$Pz','$sp').'
