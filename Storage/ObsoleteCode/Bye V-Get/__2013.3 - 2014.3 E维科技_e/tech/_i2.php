...
$Qq=mysql_query(\'SELECT i,t,h,g,d FROM f2013 WHERE \'.$ASQ0.\' AND m="\'.$M.\'" ORDER BY i DESC LIMIT \'.$Qp.\','.constant('TECH_I_page_article').'\',$QC);
$Qy=mysql_query(\'SELECT COUNT(*) FROM f2013 WHERE \'.$ASQ0.\' AND m="\'.$M.\'"\',$QC);
$Qz=mysql_fetch_array($Qy);
$Qt=$Qz[0];$Pz=ceil($Qt/'.constant('TECH_I_page_article').');
?>';
$text.=constant('CSSJS').'<link rel="stylesheet" type="text/css" href="'.constant('LTU').'f.css" /><link rel="stylesheet" type="text/css" href="'.constant('LTU_8').'tech/f.css" /><?php echo \'<title>\',$M,\'：\',$ASQ1,\'_E维站长之家_V-Get!</title><meta name="keywords" content="\',$M,\' \',$ASQ1,\',SEO,站长之家,网络营销,PHP教程,网络创业"/><meta name="description" content="\',$ASQ[2],\'"/>\';?>';

$text.=TUN('tech');

$text.='<div class="o mh"></div><div class="mg a960x60">'.constant('AD960x90pic').'</div><div class="v"><div class="l"><div class="vb1c"><?php
echo \'<div class="m mb">您的位置：
<a href="http://e.v-get.com/">首页</a>&nbsp;&gt;&gt;&nbsp;<a href="http://e.v-get.com/tech/">站长之家</a>&nbsp;&gt;&gt;&nbsp;<a href="http://e.v-get.com/tech/\',$SQ,\'_1.html">\',$ASQ1,\'</a>&nbsp;&gt;&gt;&nbsp;<a href="http://e.v-get.com/tech/\',$M,\'_1.html">\',$M,\'</a><span></span></div>\';
