...
var L_FilterTip_TEXT = "语言筛选器";	// 语言按钮的工具提示
var L_Language_TEXT = "语言";		// 编程语言菜单的标题
var L_ShowAll_TEXT = "显示所有语言";		// “显示所有语言”菜单项的标签
// 供动画文本使用的变量
...
// 检查 <meta Name="ScriptSettings" RefTips="False">
	if (bRefTips=="True"){
...
function writemessagelink(){
	//将跳转写入 PSS  Web 站点重定向器
	//代码待定
	//使用脚本顶部“本地化变量”部分的 L_MessageLink_TEXT 变量。
	msdnid = arguments[0];
