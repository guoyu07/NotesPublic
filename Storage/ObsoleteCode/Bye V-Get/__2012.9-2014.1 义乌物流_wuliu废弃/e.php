...
<script type="text/javascript" src="http://www.v-get.com/c.js"></script>
<body>
<div class="d1">
<form action="el.php" method="get" target="_blank"  onsubmit="javascript:if(L(this.n.value)<=0)return false;">

<p><span class="t"><a href="el.php?v=100-0-0-0&e='.$e.'" target="_blank"><img i="'.$l.'/favicon.ico" onerror="javascript:this.src=\'http://localhost:8080/v-get.com/i/i2.ico\'" />'.$m.'</a>（'.$p.'）</span><a href="el.php?v=0-100-0-0&e='.$e.'" class="ssss" target="_blank">寄件</a><a href="el.php?v=0-0-100-0&e='.$e.'" class="ssss" target="_blank">邮费</a></p>
<p class="p1"><select id="ses"><option>'.$e.'</option></select><input type="text" class="n" name="n" autocomplete="off"/><input type="submit" value="查单" class="b"/><span q="'.$q.'"></span></p>
<p><a href="e.php?e=SF">顺丰</a><a href="e.php?e=EMS">邮政EMS</a><a href="e.php?e=STO">申通</a><a href="e.php?e=YTO">圆通</a><a href="e.php?e=YD">韵达</a><a href="e.php?e=ZJS">宅急送</a><a href="e.php?e=TT">天天</a><a href="e.php?e=HT">汇通</a><a href="e.html">&gt;&gt;</a></p>
...
<!--
Q();
//E("ses","click",function(){window.location.href="e.html"});
-->
</script>
';
?>
