...
</div><div class="q l"><div class="o mh"></div>
...
echo '</div><div class="cfi p"><img src="http://localhost/www.v-getimg.com/i1/s3/f/300x200/',$M,'.jpg" width="300" height="200" alt="',$cH,'" /></div>',$Qa['b'];?>
</div>
</div>
<div class="o mh"></div>
</div>
