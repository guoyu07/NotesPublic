...
$bl=false;$iH='';$iD='';
if(isset($_GET['show'])){
$iP=$_GET['show'];$iX=1;$IX='_';if(empty($_GET['i'])){$iX=0;$IX='';}
if($iP==0){header('HTTP/1.1 301 Moved Permanently');
if($iX==0){header('Location: http://localhost/'.$M.'.wuliu.v-get.com/logistics/exhibition.html');}
else {header('Location: http://localhost/'.$M.'.wuliu.v-get.com/logistics/services.html');}
exit();}
$Qqi=mysql_query('SELECT * FROM fi WHERE m="'.$M.'" AND p='.$iP.' AND x='.$iX.' LIMIT 1');
$Qqr=mysql_num_rows($Qqi);if($Qqr==0){
if($iX==0){header('Location: http://localhost/'.$M.'.wuliu.v-get.com/logistics/exhibition.html');}
else {header('Location: http://localhost/'.$M.'.wuliu.v-get.com/logistics/services.html');}
exit();}
...
echo '<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"/><title>',$iH,' ',$H,'展厅_',$Z,$K,'_商务物流网_V-Get!</title><meta name="keywords" content="',$K,'" /><meta name="description" content="',$iD,$Qa['d'],$Z,'就选',$H,'"/>';?>
...
<div id="n" class="a"><?php echo '<a href="http://localhost/',$M,'.wuliu.v-get.com/">首页</a><i></i><a href="http://localhost/',$M,'.wuliu.v-get.com/logistics/about.html">公司介绍</a><i></i><a href="http://localhost/',$M,'.wuliu.v-get.com/logistics/services.html">服务项目</a><i></i><a href="http://localhost/',$M,'.wuliu.v-get.com/logistics/honor.html">企业荣誉</a><i></i><a href="http://localhost/',$M,'.wuliu.v-get.com/logistics/certificate.html">诚信认证</a><i></i><a href="http://localhost/',$M,'.wuliu.v-get.com/logistics/exhibition.html" class="no">视觉展厅</a><i></i><a href="http://localhost/',$M,'.wuliu.v-get.com/logistics/news.html">新闻公告</a><i></i><a href="http://localhost/',$M,'.wuliu.v-get.com/logistics/contact.html">联系我们</a>';?><i></i></div><div class="o mh"></div><div class="v"><div class="p l"><div class="o mh"></div>
<div class="m cc"><div>您现在的位置：<?php echo '<a href="http://',$M,'.wuliu.v-get.com/">',$H,'</a>';?> &gt; 视觉展厅</div></div>

<?php 
//如果为空，那么就是显示图册

if($bl){
echo '<div class="cc cit"><h2>',$iH,'</h2></div><div class="po ii f"><div class="iii ho"><img src="http://localhost/www.v-getimg.com/i1/s3/f/600/',$M,$IX,$iP,'.jpg" alt="',$iD,'"/></div><div class="iia pr a"><a href="http://localhost/',$M,'.wuliu.v-get.com/logistics/exhibition.html?i=',$iX,'&show=',($iP-1),'" class="iil" target="_self"></a><a href="http://localhost/',$M,'.wuliu.v-get.com/logistics/exhibition.html?i=',$iX,'&show=',($iP+1),'" class="iir" target="_self"></a><div class="o"></div></div></div><div class="o mh"></div><div class="cib"><p>',$iD,'</p></div>';

}
else {

echo '<div class="a ca">';
$Qqi=mysql_query('SELECT * FROM fi WHERE m="'.$M.'" AND x=0');
while($Qai=mysql_fetch_array($Qqi)){
$iP=$Qai['p'];$iH=$Qai['h'];
echo '<a href="http://localhost/',$M,'.wuliu.v-get.com/logistics/exhibition.html?show=',$iP,'"><img src="http://localhost/www.v-getimg.com/i1/s3/f/205x110/',$M,$Qai['p'],'.jpg" width="205" height="110" alt="',$iH,'"/><br>',$iH,'<br>',$Qai['d'],'</a>';
}
