...
<div class="o mh"></div>
					...
					(function(){
						...
						m.addOverlay(k);
						<?php echo 'w=new BMap.InfoWindow(',"'",'<div class="map"><img src="http://www.v-get.com/www.v-getimg.com/i1/s3/70/',$M,'.gif" /><ul>',$Qa['r'],'<li>网　址：',$LW,'</li></ul></div>',"'",',{/*width:250,height:100,*/title:"',$H,'"});';?>
