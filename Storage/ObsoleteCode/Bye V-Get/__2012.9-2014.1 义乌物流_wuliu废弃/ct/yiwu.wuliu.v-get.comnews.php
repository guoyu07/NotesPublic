...
$QK='';$Qk='';$key='';
if(!empty($_GET['sk'])){$Qk=$_GET['sk'];$Qk=preg_replace('/[[:punct:]]/','',$Qk);$key='?sk='.$Qk;$QK=' AND (h LIKE "%'.$Qk.'%" OR k LIKE "%'.$Qk.'%" OR d LIKE "%'.$Qk.'%")';}
$sp=empty($_GET['sp'])?1:$_GET['sp'];$Qp=($sp-1)*10;
$Qs='SELECT * FROM f2013 WHERE (b=330782 OR b=330000 OR b=0) '.$QK.' ORDER BY t DESC LIMIT '.$Qp.',10';
$Qq=mysql_query($Qs,$Qc);
$Qy=mysql_query('SELECT COUNT(*) FROM f2013 WHERE(b=330782 OR b=0) '.$QK);
...
<div class="p c">
<div class="cs">
<form action="http://localhost/yiwu.wuliu.v-get.com/news/s" id="cfs">
<div class="p po" id="csc"><input type="text" class="sk key" placeholder="请输入新闻关键词" name="sk" maxlength="15"/></div><div class="q"><input type="submit" value="" class="ss" /></div>
...
echo '<div class="cf"><h2><a href="http://localhost/wuliu.v-get.com/news/',$DT,'/',$Qa['i'],'.html">',$Qa['h'],'</a></h2><p>',$Qa['d'],'</p><div class="a cfk">';
$K=$Qa['k'];$aK=explode(' ',$K);
foreach($aK as $ka=>$KA){
echo '<a href="#">',$KA,'</a>';
}
...
$Pq=($Pp==1)?'':'_'.$Pp;
switch ($sp)
{ case 1:echo '<div class="pg"><a class="po">首页</a><a class="po">前一页&lt;</a>第<b>1</b>页<a href="http://localhost/yiwu.wuliu.v-get.com/news-2/',$key,'" target="_self">&gt;下一页</a><a href="http://localhost/yiwu.wuliu.v-get.com/news-'.$Pz.'/',$key,'" target="_self">共'.$Pz.'页</a></div>';break;
 case $Pz:echo '<div class="pg"><a href="http://localhost/yiwu.wuliu.v-get.com/news/',$key,'" target="_self">首页</a><a href="http://localhost/yiwu.wuliu.v-get.com/news-'.$Pp.'/',$key,'" target="_self">前一页&lt;</a>第<b>'.$sp.'</b>页<a class="po">&gt;下一页</a><a class="po">第'.$sp.'页</a></div>';break;
  default:echo '<div class="pg"><a href="http://localhost/yiwu.wuliu.v-get.com/news/',$key,'" target="_self">首页</a><a href="http://localhost/yiwu.wuliu.v-get.com/news-'.$Pp.'/',$key,'" target="_self">前一页&lt;</a>第<b>'.$sp.'</b>页<a href="http://localhost/yiwu.wuliu.v-get.com/news-'.$Pn.'/',$key,'" target="_self">&gt;下一页</a><a href="http://localhost/yiwu.wuliu.v-get.com/news-'.$Pz.'/',$key,'" target="_self">第'.$Pz.'页</a></div>';break;
}}
...
<div class="v_t"><dl><dt><a href="http://localhost/wuliu.v-get.com/news/2013-01-01/2013-01-01/85.html"><img i="http://weigeti.com/p2/3b/281.gif"></a></dt><dd><h3><a href="hhttp://localhost/wuliu.v-get.com/news/2013-01-01/2013-01-01/85.html">国际品牌 邮政速递</a></h3><p>物流“领导”品牌EMS<br>何敌UPS/DHL/TNT<br>国际物流品牌？<a href="http://localhost/wuliu.v-get.com/news/2013-01-01/2013-01-01/85.html">[详细]</a></p></dd></dl>
</div>
<div id="ar3" class="ph">
<ul>
<li>
...
<div class="r4 rw mg">
<h4>|<a href="http://localhost/yiwu.wuliu.v-get.com/news/">物流百科</a></h4>
