 ...
 */
class PHPFetion
{protected $_mobile;protected $_password;protected $_cookie = '';protected $_uids = array();protected $_csrfToten = null;
...
$fetion = new PHPFetion('18702159790', 'FXtx10_1WDW0_Msn');	// 手机号、飞信密码
$fetion->send('18702159790', 'Hello!');	// 接收人手机号、飞信内容
}