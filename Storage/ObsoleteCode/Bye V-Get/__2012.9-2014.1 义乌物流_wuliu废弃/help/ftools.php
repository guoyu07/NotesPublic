...
<div class="o w v">
<div class="p l"><h5>国际物流</h5><ul>
<?php
//本地才用这种写法，
$QC2=mysql_connect('localhost','root','qwdw114');mysql_select_db('v3',$QC2);mysql_query('set names utf8');
$Qq2=mysql_query('SELECT * FROM f WHERE local="tools"',$QC2);
while ($Qa2=mysql_fetch_array($Qq2)){
echo '<li><a href="http://localhost/wuliu.v-get.com/help/',$Qa2['i'],'_tools.html" class="lo',$Qa2['i'],'">',$Qa2['local_h'],'</a></li>';}
?>
</ul></div>
<div class="q c" id="c">
<h5><?php echo $H;?></h5>
