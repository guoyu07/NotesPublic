...
<link href="http://localhost/www.v-getimg.com/i0/s3/i.css" type="text/css" rel="stylesheet"/>
<link href="http://localhost/www.v-getimg.com/i0/s3/icompany.css" type="text/css" rel="stylesheet" />
...
<div id="n" class="a"><a href="http://localhost/yiwu.wuliu.v-get.com/">首页</a><i></i><a href="http://wuliu.news.v-get.com/">新闻</a><i></i><a href="http://wuliu.baike.v-get.com/">百科</a><i></i><a href="http://localhost/yiwu.wuliu.v-get.com/tuoyun/">公司</a><i></i><a href="http://localhost/yiwu.wuliu.v-get.com/cangku/">运费</a><i></i><a href="http://localhost/yiwu.wuliu.v-get.com/banjia/">问答</a><i></i><a href="http://localhost/yiwu.wuliu.v-get.com/huoche/">社区</a></div>
<div class="o mh"></div>
...
?>
<a href="http://localhost/yiwu.wuliu.v-get.com/price/yiwu-tuoyun.html">托运价格</a><a href="http://localhost/yiwu.wuliu.v-get.com/keyun/">客车托运</a><a href="http://news.v-get.com/view/193.html">限货区域</a>
</li>
</ul>
</div>
<!--关注度采用每周，或者每月统计百度的-->
...
echo '<div class="f cc"><div class="cct">|&nbsp;&nbsp;义乌',$a,'<span>约',$Qt,'个</span></div><div id="c">';	 
	 ...
	 echo '<div class="cv">
		 <h2><a href="http://localhost/wuliu.v-get.com/',$i,'" class="h2c">',$h,'</a><a v="',$v,'"></a><a o="',$Qa['o'],'"></a><a href="#" class="h2r pr" b="',$i,'"></a></h2><div class="o p cl">
		 <a href="http://localhost/wuliu.v-get.com/',$i,'"><img i="http://localhost/www.v-get.com/i1/v3/50/',$bP,'.gif" alt="',$h,'"></a>
		 </div>
		 <div class="p cr"><p>',$Qa['d'],'</p></div>
	 <div class="o cb"><div class="p">wuliu.v-get.com/',$i,'&nbsp;&nbsp;',$Qa['t'],'</div><div q="',$Qa['q'],'^Jlocalhost/yiwu.wuliu.v-get.com/',$sa,'-price/';
	 if($R>0){echo '?sco=',$R;}
	 echo '" class="q"></div></div>
