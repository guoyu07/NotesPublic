...
class Regime
{
  ...
  func impose(){
    confinement {print("confinement"); self.authoritarian = 100}
    aggresive {print("aggresive"); authoritarian = 200 } // @noescape within a `self` implicitly
    fund { print("fund"); self.authoritarian = 500 }
  }
}
